...
> from backend.shared.clients import qdrant_client, qdrant_ingest_client  # AUDIT FIX (P2-04 + P10-25)
> 
> router = APIRouter()
...
│ ────────────────────────────────────────────────── │
│ RAG Context Budget                    ~26,203 tokens│  ← AUDIT FIX (P10-01): was 26,218
...
def validate(path: str) -> bool:
    ...
    remaining_no_chat = 32768 - 900 - count - 2000 - FRAMEWORK_OVERHEAD - INJECTION_OVERHEAD
