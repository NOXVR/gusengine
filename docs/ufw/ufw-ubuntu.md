# Source: https://manpages.ubuntu.com/manpages/noble/man8/ufw.8.html
...
RULE SYNTAX
       ...
       comment updates the comment and specifying '' removes the comment (note, 'insert' and 'prepend' cannot be
...
NOTES
       ...
       keepalived is supported by using the 'vrrp' ('112') protocol. This protocol can only  be  used  with  the
