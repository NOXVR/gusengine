<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/instance-states/ -->
# Instance states
...
These instance states reflect the various stages an instance can be in while using Multipass. Instances in different states can accept different commands. See [Command-line interface](../command-line-interface/) for more information on which commands can be used and when.