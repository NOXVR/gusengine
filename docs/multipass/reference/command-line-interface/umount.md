<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/umount/ -->
# umount

# umount[¶](#umount)

See also: [`mount`](../mount/), [Mount](../../../explanation/mount/), [How to share data with an instance](../../../how-to-guides/manage-instances/share-data-with-an-instance/).
