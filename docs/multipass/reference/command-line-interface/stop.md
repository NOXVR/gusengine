<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/stop/ -->
# stop

# stop[¶](#stop)

The `multipass stop` command without any argument will stop the [Primary instance](../../../explanation/instance/#primary-instance)
...
`Stopped` instances can be started again with [`multipass start`](../start/).
