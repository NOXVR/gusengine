<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/delete/ -->
# delete

# delete[¶](#delete)

See also: [`recover`](../recover/), [`purge`](../purge/)
...
To completely destroy instances and release the disk space they take up, use the `--purge` option or the [`purge`](../purge/) command.

Caution

When you delete a [snapshot](../../../explanation/snapshot/), or when you delete an instance using the [GUI client](../../gui-client/), Multipass removes them permanently (even if you didn’t use the `--purge` option) and they cannot be recovered.
