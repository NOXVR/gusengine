<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/set/ -->
# set

# set[¶](#set)

See also: [`get`](../get/), [Settings](../../settings/)
...
To find what the configured value is at any moment, see [`get`](../get/).

You can read more about the available settings in the [Settings](../../settings/) reference page.
