<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/restore/ -->
# restore

# restore[¶](#restore)

See also: [`snapshot`](../snapshot/), [`list`](../list/), [`info`](../info/), [`delete`](../delete/)
