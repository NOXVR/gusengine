<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/mount/ -->
# mount

# mount[¶](#mount)

See also: [How to share data with an instance](../../../how-to-guides/manage-instances/share-data-with-an-instance/), [Mount](../../../explanation/mount/), [`umount`](../umount/)
...
**Contributors:** @georgeliaojia, @sharder996, @davidekete, @gzanchi 
-->