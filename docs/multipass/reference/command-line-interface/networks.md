<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/networks/ -->
# networks
...
Like [`list`](../list/), `networks` supports the `--format` option.
...
See [`launch`](../launch/) and [Create an instance with multiple network interfaces](../../../how-to-guides/manage-instances/create-an-instance/#create-an-instance-with-multiple-network-interfaces) for instructions on how to use these.
