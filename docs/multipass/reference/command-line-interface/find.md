<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/find/ -->
# find

# find[¶](#find)

The `multipass find` command without any argument lists the images and blueprints Multipass can use to run instances with [`launch`](../launch/) on your system and associated version information. For example:
