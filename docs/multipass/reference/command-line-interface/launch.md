<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/launch/ -->
# launch
...
The only, optional, positional argument is the image to launch an instance from. See [`find`](../find/) for how to find information on the available images.
...
If you want your instance to have a name of your choice, use the `--name` option. The instance name has to be unique and conform to a specific [instance name format](../../instance-name-format/).
...
Use the `--network` option to [Create an instance with multiple network interfaces](../../../how-to-guides/manage-instances/create-an-instance/#create-an-instance-with-multiple-network-interfaces).
