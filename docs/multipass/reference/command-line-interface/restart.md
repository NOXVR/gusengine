<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/restart/ -->
# restart

# restart[¶](#restart)

The `multipass restart` command without any argument will restart the [Primary instance](../../../explanation/instance/#primary-instance) (and fail, if it doesn’t exist). You can also pass one or more instance names or the `--all` option to restart more instances at the same time.
