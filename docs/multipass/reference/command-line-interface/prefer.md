<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/prefer/ -->
# prefer
...
Subsequent calls to [`alias`](../alias/) , [`unalias`](../unalias/) and running any aliases from the command line will use the aliases defined in the given context.
