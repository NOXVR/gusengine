<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/get/ -->
# get

# get[¶](#get)

See also: [`set`](../set/), [Settings](../../settings/)
...
To set the value of a particular setting, see [`set`](../set/).
