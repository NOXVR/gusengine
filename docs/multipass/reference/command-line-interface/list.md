<!-- Source: https://documentation.ubuntu.com/multipass/stable/reference/command-line-interface/list/ -->
# list

# list[¶](#list)

See also: [`info`](../info/), [`launch`](../launch/), [`snapshot`](../snapshot/)
...
The `multipass list` command will truncate long snapshot comments, as well as those containing newlines. You can use [`info`](../info/) to view them in full.
