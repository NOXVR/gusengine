<!-- Source: https://documentation.ubuntu.com/multipass/stable/explanation/blueprint/ -->
# Blueprint (deprecated)

# Blueprint (deprecated)[¶](#blueprint-deprecated)
...
In Multipass, a **blueprint** is a recipe to create a customised Multipass [instance](../instance/).
