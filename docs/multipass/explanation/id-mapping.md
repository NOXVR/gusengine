<!-- Source: https://documentation.ubuntu.com/multipass/stable/explanation/id-mapping/ -->
# ID mapping

# ID mapping[¶](#explanation-id-mapping)

See also: [`mount`](../../reference/command-line-interface/mount/), [Mount](../mount/), [How to share data with an instance](../../how-to-guides/manage-instances/share-data-with-an-instance/)
