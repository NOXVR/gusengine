<!-- Source: https://documentation.ubuntu.com/multipass/stable/explanation/service/ -->
# Service

# Service[¶](#service)

See also: [Command-line interface](../../reference/command-line-interface/), [GUI client](../../reference/gui-client/), [Instance](../instance/)
...
The Multipass daemon (`multipassd`) runs in the background and processes the requests from the Multipass [command-line interface](../../reference/command-line-interface/) and [GUI client](../../reference/gui-client/). The daemon is also in charge of the lifecycle of Multipass [instances](../instance/).
