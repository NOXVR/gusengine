<!-- Source: https://documentation.ubuntu.com/multipass/stable/explanation/about-performance/ -->
# About performance
...
- 
the [Multipass instance](../instance/)
...
### CPUs/cores/threads[¶](#cpus-cores-threads)
...
## Multipass instances[¶](#multipass-instances)
