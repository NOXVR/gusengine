<!-- Source: https://documentation.ubuntu.com/multipass/stable/explanation/multipass-exec-and-shells/ -->
...
## How `exec` parses commands[¶](#how-exec-parses-commands)
...
## How SSH parses commands[¶](#how-ssh-parses-commands)
...
## Using a shell to parse commands[¶](#using-a-shell-to-parse-commands)
...
## Other shell tricks[¶](#other-shell-tricks)
