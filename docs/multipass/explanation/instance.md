<!-- Source: https://documentation.ubuntu.com/multipass/stable/explanation/instance/ -->
# Instance

# Instance[¶](#instance)

See also: [How to manage instances](../../how-to-guides/manage-instances/), [Instance states](../../reference/instance-states/), [Mount](../mount/)
...
The Multipass [Command-line interface](../../reference/command-line-interface/) (CLI) provides a few shortcuts using a special instance, called *primary* instance. By default, this is the instance named `primary`.
...
On Windows, mounts are disabled by default for security reasons. For more details, see [Security considerations](../mount/#security-considerations-mount).
...
### Selecting the primary instance[¶](#selecting-the-primary-instance)
