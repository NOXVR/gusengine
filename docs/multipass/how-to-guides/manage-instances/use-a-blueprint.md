<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/manage-instances/use-a-blueprint/ -->
# Use a blueprint (deprecated)

# Use a blueprint (deprecated)[¶](#use-a-blueprint-deprecated)
