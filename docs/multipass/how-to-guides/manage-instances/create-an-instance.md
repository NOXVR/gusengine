<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/manage-instances/create-an-instance/ -->
# Create an instance
...
## Create an instance with a specific image[¶](#create-an-instance-with-a-specific-image)
...
## Create an instance with a custom name[¶](#create-an-instance-with-a-custom-name)
...
## Create an instance with custom CPU number, disk and RAM[¶](#create-an-instance-with-custom-cpu-number-disk-and-ram)
...
## Create an instance with primary status[¶](#create-an-instance-with-primary-status)
...
For more information, see [How to use the primary instance](../use-the-primary-instance/).

## Create an instance with multiple network interfaces[¶](#create-an-instance-with-multiple-network-interfaces)
...
## Create an instance with a custom DNS[¶](#create-an-instance-with-a-custom-dns)
...
### The `--cloud-init` approach[¶](#the-cloud-init-approach)
...
### The Netplan approach[¶](#the-netplan-approach)
