<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/manage-instances/use-the-primary-instance/ -->
...
Multipass offers a quick way to access an Ubuntu instance via a simple `multipass shell` command. This is achieved via the so-called [Primary instance](../../../explanation/instance/#primary-instance) that is also automatically created (if it doesn’t exist) when the user runs the [`multipass start`](../../../reference/command-line-interface/start/) or [`multipass shell`](../../../reference/command-line-interface/shell/) commands without any arguments.
...
## Steering the primary instance[¶](#steering-the-primary-instance)

The primary instance can also be controlled from the [Tray icon](../../../reference/gui-client/#gui-client-tray-icon)
...
## Automatic home mount[¶](#automatic-home-mount)
...
## Changing the primary instance[¶](#changing-the-primary-instance)
