<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/manage-instances/configure-static-ips/ -->
...
## Step 2: Launch an instance with a manual network[¶](#step-2-launch-an-instance-with-a-manual-network)
...
## Step 3: Configure the extra interface[¶](#step-3-configure-the-extra-interface)
...
## Step 4: Apply the new configuration[¶](#step-4-apply-the-new-configuration)
...
## Step 5: Confirm that it works[¶](#step-5-confirm-that-it-works)
...
## Step 6: More instances[¶](#step-6-more-instances)
