<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/manage-instances/use-the-docker-blueprint/ -->
# Use the Docker blueprint (deprecated)

# Use the Docker blueprint (deprecated)[¶](#use-the-docker-blueprint-deprecated)
