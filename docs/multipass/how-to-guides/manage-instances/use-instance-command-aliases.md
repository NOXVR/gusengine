<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/manage-instances/use-instance-command-aliases/ -->
# Use instance command aliases

# Use instance command aliases[¶](#use-instance-command-aliases)

See also: [Alias](../../../explanation/alias/), [How to use command aliases](#), [Instance](../../../explanation/instance/).
...
### Working directory mapping[¶](#working-directory-mapping)
...
## List the existing aliases[¶](#list-the-existing-aliases)
...
### `multipass <alias>`[¶](#multipass-alias)
...
#### Add the Multipass alias script folder to the system path[¶](#add-the-multipass-alias-script-folder-to-the-system-path)
