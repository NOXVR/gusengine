<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/manage-instances/use-an-instance/ -->
# Use an instance
...
## Open a shell prompt inside an instance[¶](#open-a-shell-prompt-inside-an-instance)
...
## Run a command inside an instance[¶](#run-a-command-inside-an-instance)
...
## Suspend an instance[¶](#suspend-an-instance)
...
### Stop an instance forcefully[¶](#stop-an-instance-forcefully)
