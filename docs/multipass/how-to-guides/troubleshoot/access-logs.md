<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/troubleshoot/access-logs/ -->
# Access logs

# Access logs[¶](#access-logs)

Logs are our first go-to when something goes wrong. Multipass is comprised of a daemon process (service) and the [CLI](../../../reference/command-line-interface/) and [GUI](../../../reference/gui-client/) clients, each of them reporting on their own health.
...
See also: [Logging levels](../../../reference/logging-levels/), [Configure Multipass’s default logging level](../../customise-multipass/configure-multipass-default-logging-level/)
