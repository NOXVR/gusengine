<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/install-multipass/ -->
# Install Multipass
...
You will need either Hyper-V enabled (only Windows 10 Professional or Enterprise), or VirtualBox installed. See [Check prerequisites](#install-multipass-prerequisites).
...
[How to set up the driver](../customise-multipass/set-up-the-driver/), [How to use a different terminal from the system icon](../customise-multipass/use-a-different-terminal-from-the-system-icon/)
...
See also: [How to set up the driver](../customise-multipass/set-up-the-driver/).
