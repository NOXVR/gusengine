<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/customise-multipass/set-up-a-graphical-interface/ -->
...
## Using X11 forwarding[¶](#using-x11-forwarding)
