<!-- Source: https://documentation.ubuntu.com/multipass/stable/how-to-guides/customise-multipass/build-multipass-images-with-packer/ -->
...
## Setting up the build directory[¶](#setting-up-the-build-directory)
