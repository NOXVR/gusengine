# Source: https://libguestfs.org/guestfish.1.html
...
This function is deprecated. In new code, use the "btrfs-scrub-full" call instead.
...
This function is deprecated. In new code, use the "setfiles" call instead.
...
` tar-in (tarfile|-) directory [compress:..] [xattrs:true|false] [selinux:true|false] [acls:true|false] [keepdirlink:true|false]`
...
This function is deprecated. In new code, use the "xfs-info2" call instead.
