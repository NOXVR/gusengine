# Source: https://libguestfs.org/virt-filesystems.1.html
...
In --long mode, display the filesystem version. Currently this only has any effect for XFS, displaying either `4` (for XFS v4) or `5` (for XFS v5). XFS v4 support will be removed from Linux in 2030.
...
Use --fs-version to display filesystem versions.

Use --uuid to display UUIDs.
