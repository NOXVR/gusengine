...
Log in
Using the API
API overviewLoading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...Loading...
...
HeaderValueRequired`x-api-key`Your API key from ConsoleYes`anthropic-version`API version (e.g., `2023-06-01`)Yes`content-type``application/json`Yes
...
PlatformProviderDocumentationAmazon BedrockAWSClaude on Amazon BedrockVertex AIGoogle CloudClaude on Vertex AIAzure AIMicrosoft AzureClaude on Azure AI
...
EndpointMaximum SizeStandard endpoints (Messages, Token Counting)32 MBBatch API256 MBFiles API500 MB
