          ...
          message.copilot_references = [
            {
              data: {
                ...
                ...(this.includePageContext && {
                  ...
                  page_title: "View container logs"
                })
              }
            }
          ]
...
[Request changes](https://github.com/docker/docs/issues/new?template=doc_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fengine%2flogging%2f&labels=status%2Ftriage)
Table of contents
