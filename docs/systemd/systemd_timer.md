...
## AUTOMATIC DEPENDENCIES          top
   ...
   Implicit Dependencies
       ...
       â¢   Timer units automatically gain a Before= dependency on the
   ...
   Default Dependencies
       ...
       â¢   Timer units will automatically have dependencies of type
       ...
       â¢   Timer units with at least one OnCalendar= directive acquire a
...
## OPTIONS          top
       ...
       OnUnitInactiveSec=
           ...
           â Setting            â Meaning                  â
           ââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â OnActiveSec=       â Defines a timer relative â
           â                    â to the moment the timer  â
           â                    â unit itself is           â
           â                    â activated.               â
           ââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â OnBootSec=         â Defines a timer relative â
           â                    â to when the machine was  â
           â                    â booted up. In            â
           â                    â containers, for the      â
           â                    â system manager instance, â
           â                    â this is mapped to        â
           â                    â OnStartupSec=, making    â
           â                    â both equivalent.         â
           ââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â OnStartupSec=      â Defines a timer relative â
           â                    â to when the service      â
           â                    â manager was first        â
           â                    â started. For system      â
           â                    â timer units this is very â
           â                    â similar to OnBootSec= as â
           â                    â the system service       â
           â                    â manager is generally     â
           â                    â started very early at    â
           â                    â boot. It's primarily     â
           â                    â useful when configured   â
           â                    â in units running in the  â
           â                    â per-user service         â
           â                    â manager, as the user     â
           â                    â service manager is       â
           â                    â generally started on     â
           â                    â first login only, not    â
           â                    â already during boot.     â
           ââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â OnUnitActiveSec=   â Defines a timer relative â
           â                    â to when the unit the     â
           â                    â timer unit is activating â
           â                    â was last activated.      â
           ââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â OnUnitInactiveSec= â Defines a timer relative â
           â                    â to when the unit the     â
           â                    â timer unit is activating â
           â                    â was last deactivated.    â
           ââââââââââââââââââââââ´âââââââââââââââââââââââââââ
...
systemd 260~devel                                        SYSTEMD.TIMER(5)
