...
NAME | SYNOPSIS | DESCRIPTION | IMPLICIT DEPENDENCIES | PATHS | USER/GROUP IDENTITY | CAPABILITIES | SECURITY | MANDATORY ACCESS CONTROL | PROCESS PROPERTIES | SCHEDULING | SANDBOXING | SYSTEM CALL FILTERING | ENVIRONMENT | LOGGING AND STANDARD INPUT/OUTPUT | CREDENTIALS | SYSTEM V COMPATIBILITY | ENVIRONMENT VARIABLES IN SPAWNED PROCESSES | PROCESS EXIT CODES | EXAMPLES | SEE ALSO | NOTES | COLOPHON
...
## IMPLICIT DEPENDENCIES          top
       ...
       â¢   Units with WorkingDirectory=, RootDirectory=, RootImage=,
       ...
       â¢   Units with PrivateTmp=yes automatically gain dependencies of
       ...
       â¢   Units with PrivateTmp=disconnected automatically gain
       ...
       â¢   Units whose standard output or error output is connected to
       ...
       â¢   Units using LogNamespace= will automatically gain ordering and
...
## USER/GROUP IDENTITY          top
       ...
       User=, Group=
           ...
           started, and released at the time the service is stopped â
...
## PROCESS PROPERTIES          top
       ...
       LimitRTPRIO=, LimitRTTIME=
           ...
           systemd-system.conf(5), and â if not configured there â the
           ...
           â Directive        â ulimit     â Unit            â Notes                        â
           â                  â equivalent â                 â                              â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitCPU=        â ulimit -t  â Seconds         â -                            â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitFSIZE=      â ulimit -f  â Bytes           â -                            â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitDATA=       â ulimit -d  â Bytes           â Do not use.                  â
           â                  â            â                 â This limits the              â
           â                  â            â                 â allowed address              â
           â                  â            â                 â range, not                   â
           â                  â            â                 â memory use!                  â
           â                  â            â                 â Defaults to                  â
           â                  â            â                 â unlimited and                â
           â                  â            â                 â should not be                â
           â                  â            â                 â lowered. To                  â
           â                  â            â                 â limit memory                 â
           â                  â            â                 â use, see                     â
           â                  â            â                 â MemoryMax= in                â
           â                  â            â                 â systemd.resource-control(5). â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitSTACK=      â ulimit -s  â Bytes           â -                            â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitCORE=       â ulimit -c  â Bytes           â -                            â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitRSS=        â ulimit -m  â Bytes           â Do not use. No effect on     â
           â                  â            â                 â Linux.                       â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitNOFILE=     â ulimit -n  â Number of File  â Do not use. Be careful when  â
           â                  â            â Descriptors     â raising the soft limit above â
           â                  â            â                 â 1024, since select(2) cannot â
           â                  â            â                 â function with file           â
           â                  â            â                 â descriptors above 1023 on    â
           â                  â            â                 â Linux. Nowadays, the hard    â
           â                  â            â                 â limit defaults to 524288, a  â
           â                  â            â                 â very high value compared to  â
           â                  â            â                 â historical defaults.         â
           â                  â            â                 â Typically applications       â
           â                  â            â                 â should increase their soft   â
           â                  â            â                 â limit to the hard limit on   â
           â                  â            â                 â their own, if they are OK    â
           â                  â            â                 â with working with file       â
           â                  â            â                 â descriptors above 1023, i.e. â
           â                  â            â                 â do not use select(2). Note   â
           â                  â            â                 â that file descriptors are    â
           â                  â            â                 â nowadays accounted like any  â
           â                  â            â                 â other form of memory, thus   â
           â                  â            â                 â there should not be any need â
           â                  â            â                 â to lower the hard limit. Use â
           â                  â            â                 â MemoryMax= to control        â
           â                  â            â                 â overall service memory use,  â
           â                  â            â                 â including file descriptor    â
           â                  â            â                 â memory.                      â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitAS=         â ulimit -v  â Bytes           â Do not use. This limits the  â
           â                  â            â                 â allowed address range, not   â
           â                  â            â                 â memory use! Defaults to      â
           â                  â            â                 â unlimited and should not be  â
           â                  â            â                 â lowered. To limit memory     â
           â                  â            â                 â use, see MemoryMax= in       â
           â                  â            â                 â systemd.resource-control(5). â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitNPROC=      â ulimit -u  â Number of       â This limit is enforced based â
           â                  â            â Processes       â on the number of processes   â
           â                  â            â                 â belonging to the user.       â
           â                  â            â                 â Typically it is better to    â
           â                  â            â                 â track processes per service, â
           â                  â            â                 â i.e. use TasksMax=, see      â
           â                  â            â                 â systemd.resource-control(5). â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitMEMLOCK=    â ulimit -l  â Bytes           â -                            â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitLOCKS=      â ulimit -x  â Number of Locks â -                            â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitSIGPENDING= â ulimit -i  â Number of       â -                            â
           â                  â            â Queued Signals  â                              â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitMSGQUEUE=   â ulimit -q  â Bytes           â -                            â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitNICE=       â ulimit -e  â Nice Level      â -                            â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitRTPRIO=     â ulimit -r  â Realtime        â -                            â
           â                  â            â Priority        â                              â
           ââââââââââââââââââââ¼âââââââââââââ¼ââââââââââââââââââ¼âââââââââââââââââââââââââââââââ¤
           â LimitRTTIME=     â ulimit -R  â Microseconds    â -                            â
           ââââââââââââââââââââ´âââââââââââââ´ââââââââââââââââââ´âââââââââââââââââââââââââââââââ
       ...
       UMask=
           ...
           also is 0022 â unless overridden by a PAM module). In order to
...
## SANDBOXING          top
       ...
       LogsDirectory=, ConfigurationDirectory=
           ...
           â Directory               â Below path for â Below path for       â Environment              â
           â                         â system units   â user units           â variable set             â
           âââââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â RuntimeDirectory=       â /run/          â $XDG_RUNTIME_DIR     â $RUNTIME_DIRECTORY       â
           âââââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â StateDirectory=         â /var/lib/      â $XDG_STATE_HOME      â $STATE_DIRECTORY         â
           âââââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â CacheDirectory=         â /var/cache/    â $XDG_CACHE_HOME      â $CACHE_DIRECTORY         â
           âââââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â LogsDirectory=          â /var/log/      â $XDG_STATE_HOME/log/ â $LOGS_DIRECTORY          â
           âââââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â ConfigurationDirectory= â /etc/          â $XDG_CONFIG_HOME     â $CONFIGURATION_DIRECTORY â
           âââââââââââââââââââââââââââ´âââââââââââââââââ´âââââââââââââââââââââââ´âââââââââââââââââââââââââââ
       ...
       PrivateTmp=
           ...
           â Other Settings            â tmpfs on  â $TMPVAR      â implied              â
           â                           â /var/tmp/ â              â dependencies         â
           âââââââââââââââââââââââââââââ¼ââââââââââââ¼âââââââââââââââ¼âââââââââââââââââââââââ¤
           â (none)                    â yes       â (unset)      â WantsMountsFor=/var/ â
           âââââââââââââââââââââââââââââ¼ââââââââââââ¼âââââââââââââââ¼âââââââââââââââââââââââ¤
           â RootDirectory=/RootImage= â yes       â (unset)      â (none)               â
           âââââââââââââââââââââââââââââ¼ââââââââââââ¼âââââââââââââââ¼âââââââââââââââââââââââ¤
           â DefaultDependency=no,     â yes       â (unset)      â (none)               â
           â RequiresMountsFor=/var/   â           â              â                      â
           âââââââââââââââââââââââââââââ¼ââââââââââââ¼âââââââââââââââ¼âââââââââââââââââââââââ¤
           â DefaultDependency=no,     â yes       â (unset)      â (none)               â
           â WantsMountsFor=/var/      â           â              â                      â
           âââââââââââââââââââââââââââââ¼ââââââââââââ¼âââââââââââââââ¼âââââââââââââââââââââââ¤
           â DefaultDependency=no      â no        â $TMPDIR=/tmp â (none)               â
           âââââââââââââââââââââââââââââ´ââââââââââââ´âââââââââââââââ´âââââââââââââââââââââââ
       ...
       RestrictFileSystems=
           ...
           â Set               â Description              â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @basic-api        â Basic filesystem API.    â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @auxiliary-api    â Auxiliary filesystem     â
           â                   â API.                     â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @common-block     â Common block device      â
           â                   â filesystems.             â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @historical-block â Historical block device  â
           â                   â filesystems.             â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @network          â Well-known network       â
           â                   â filesystems.             â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @privileged-api   â Privileged filesystem    â
           â                   â API.                     â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @temporary        â Temporary filesystems:   â
           â                   â tmpfs, ramfs.            â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @known            â All known filesystems    â
           â                   â defined by the kernel.   â
           â                   â This list is defined     â
           â                   â statically in systemd    â
           â                   â based on a kernel        â
           â                   â version that was         â
           â                   â available when this      â
           â                   â systemd version was      â
           â                   â released. It will become â
           â                   â progressively more       â
           â                   â out-of-date as the       â
           â                   â kernel is updated.       â
           âââââââââââââââââââââ´âââââââââââââââââââââââââââ
       ...
       RestrictNamespaces=
           ...
           specified flags parameters into account. Note that â if this
           option is used â in addition to restricting creation and
       ...
       PrivateMounts=
           ...
           Other file system namespace unit settings â PrivateTmp=,
           PrivateDevices=, ProtectSystem=, ProtectHome=, ReadOnlyPaths=,
           InaccessiblePaths=, ReadWritePaths=, BindPaths=,
           BindReadOnlyPaths=, ... â also enable file system namespacing
       ...
       MountFlags=
           ...
           If not set â but file system namespaces are enabled through
           another file system namespace unit setting â shared mount
           propagation is used, but â as mentioned â as slave is applied
...
## SYSTEM CALL FILTERING          top
       ...
       SystemCallFilter=
           ...
           for the execution of the service binary â if it is blocked
           ...
           â Set             â Description              â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @aio            â Asynchronous I/O (â      â
           â                 â io_setup(2),             â
           â                 â io_submit(2), and        â
           â                 â related calls)           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @basic-io       â System calls for basic   â
           â                 â I/O: reading, writing,   â
           â                 â seeking, file descriptor â
           â                 â duplication and closing  â
           â                 â (read(2), write(2), and  â
           â                 â related calls)           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @chown          â Changing file ownership  â
           â                 â (chown(2), fchownat(2),  â
           â                 â and related calls)       â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @clock          â System calls for         â
           â                 â changing the system      â
           â                 â clock (adjtimex(2),      â
           â                 â settimeofday(2), and     â
           â                 â related calls)           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @cpu-emulation  â System calls for CPU     â
           â                 â emulation functionality  â
           â                 â (vm86(2) and related     â
           â                 â calls)                   â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @debug          â Debugging, performance   â
           â                 â monitoring and tracing   â
           â                 â functionality (â         â
           â                 â ptrace(2),               â
           â                 â perf_event_open(2) and   â
           â                 â related calls)           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @file-system    â File system operations:  â
           â                 â opening, creating files  â
           â                 â and directories for read â
           â                 â and write, renaming and  â
           â                 â removing them, reading   â
           â                 â file properties, or      â
           â                 â creating hard and        â
           â                 â symbolic links           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @io-event       â Event loop system calls  â
           â                 â (poll(2), select(2),     â
           â                 â epoll(7), eventfd(2) and â
           â                 â related calls)           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @ipc            â Pipes, SysV IPC, POSIX   â
           â                 â Message Queues and other â
           â                 â IPC (mq_overview(7),     â
           â                 â svipc(7))                â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @keyring        â Kernel keyring access (â â
           â                 â keyctl(2) and related    â
           â                 â calls)                   â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @memlock        â Locking of memory in RAM â
           â                 â (mlock(2), mlockall(2)   â
           â                 â and related calls)       â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @module         â Loading and unloading of â
           â                 â kernel modules (â        â
           â                 â init_module(2),          â
           â                 â delete_module(2) and     â
           â                 â related calls)           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @mount          â Mounting and unmounting  â
           â                 â of file systems (â       â
           â                 â mount(2), chroot(2), and â
           â                 â related calls)           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @network-io     â Socket I/O (including    â
           â                 â local AF_UNIX):          â
           â                 â socket(7), unix(7)       â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @obsolete       â Unusual, obsolete or     â
           â                 â unimplemented (â         â
           â                 â create_module(2),        â
           â                 â gtty(2), ...)            â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @pkey           â System calls that deal   â
           â                 â with memory protection   â
           â                 â keys (pkeys(7))          â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @privileged     â All system calls which   â
           â                 â need super-user          â
           â                 â capabilities (â          â
           â                 â capabilities(7))         â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @process        â Process control,         â
           â                 â execution, namespacing   â
           â                 â operations (clone(2),    â
           â                 â kill(2), namespaces(7),  â
           â                 â ...)                     â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @raw-io         â Raw I/O port access (â   â
           â                 â ioperm(2), iopl(2),      â
           â                 â pciconfig_read(), ...)   â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @reboot         â System calls for         â
           â                 â rebooting and reboot     â
           â                 â preparation (reboot(2),  â
           â                 â kexec(), ...)            â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @resources      â System calls for         â
           â                 â changing resource        â
           â                 â limits, memory and       â
           â                 â scheduling parameters (â â
           â                 â setrlimit(2),            â
           â                 â setpriority(2), ...)     â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @sandbox        â System calls for         â
           â                 â sandboxing programs (â   â
           â                 â seccomp(2), Landlock     â
           â                 â system calls, ...)       â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @setuid         â System calls for         â
           â                 â changing user ID and     â
           â                 â group ID credentials, (â â
           â                 â setuid(2), setgid(2),    â
           â                 â setresuid(2), ...)       â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @signal         â System calls for         â
           â                 â manipulating and         â
           â                 â handling process signals â
           â                 â (signal(2),              â
           â                 â sigprocmask(2), ...)     â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @swap           â System calls for         â
           â                 â enabling/disabling swap  â
           â                 â devices (swapon(2),      â
           â                 â swapoff(2))              â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @sync           â Synchronizing files and  â
           â                 â memory to disk (â        â
           â                 â fsync(2), msync(2), and  â
           â                 â related calls)           â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @system-service â A reasonable set of      â
           â                 â system calls used by     â
           â                 â common system services,  â
           â                 â excluding any special    â
           â                 â purpose calls. This is   â
           â                 â the recommended starting â
           â                 â point for allow-listing  â
           â                 â system calls for system  â
           â                 â services, as it contains â
           â                 â what is typically needed â
           â                 â by system services, but  â
           â                 â excludes overly specific â
           â                 â interfaces. For example, â
           â                 â the following APIs are   â
           â                 â excluded: "@clock",      â
           â                 â "@mount", "@swap",       â
           â                 â "@reboot".               â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @timer          â System calls for         â
           â                 â scheduling operations by â
           â                 â time (alarm(2),          â
           â                 â timer_create(2), ...)    â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â @known          â All system calls defined â
           â                 â by the kernel. This list â
           â                 â is defined statically in â
           â                 â systemd based on a       â
           â                 â kernel version that was  â
           â                 â available when this      â
           â                 â systemd version was      â
           â                 â released. It will become â
           â                 â progressively more       â
       ...
       SystemCallArchitectures=
           ...
           socket-related calls is not possible, due to ABI limitations â
           a limitation that x86-64 does not have, however. On systems
           supporting multiple ABIs at the same time â such as x86/x86-64
           â it is hence recommended to limit the set of permitted system
...
## LOGGING AND STANDARD INPUT/OUTPUT          top
       ...
       StandardOutput=
           ...
           directed to the same file path, it is opened only once â for
           reading as well as writing â and duplicated. This is
...
## CREDENTIALS          top
       ...
       LoadCredential=ID[:PATH], LoadCredentialEncrypted=ID[:PATH]
           ...
           specified name â which may be used to propagate credentials
           ...
           /usr/lib/credstore/ for files under the credential's name â
           ...
           switches (see systemd(1) â this is not recommended since
       ...
       ImportCredential=GLOB
           ...
           service manager itself received under the specified name â
...
## ENVIRONMENT VARIABLES IN SPAWNED PROCESSES          top
       ...
       â¢   Variables globally configured for the service manager, using
       ...
       â¢   Variables defined by the service manager itself (see the list
           below).

       â¢   Variables set in the service manager's own environment
           variable block (subject to PassEnvironment= for the system
           service manager).

       â¢   Variables set via Environment= in the unit file.

       â¢   Variables read from files specified via EnvironmentFile= in
           the unit file.

       â¢   Variables set by any PAM modules in case PAMName= is in
           effect, cf. pam_env(8).

       If the same environment variable is set by multiple of these
       sources, the later source â according to the order of the list
       above â wins. Note that as the final step all variables listed in
   ...
   Environment Variables Set or Propagated by the Service Manager
       ...
       $SERVICE_RESULT
           ...
           â Value             â Meaning                  â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "success"         â The service ran          â
           â                   â successfully and exited  â
           â                   â cleanly.                 â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "protocol"        â A protocol violation     â
           â                   â occurred: the service    â
           â                   â did not take the steps   â
           â                   â required by its unit     â
           â                   â configuration            â
           â                   â (specifically what is    â
           â                   â configured in its Type=  â
           â                   â setting).                â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "timeout"         â One of the steps timed   â
           â                   â out.                     â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "exit-code"       â Service process exited   â
           â                   â with a non-zero exit     â
           â                   â code; see $EXIT_CODE     â
           â                   â below for the actual     â
           â                   â exit code returned.      â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "signal"          â A service process was    â
           â                   â terminated abnormally by â
           â                   â a signal, without        â
           â                   â dumping core. See        â
           â                   â $EXIT_CODE below for the â
           â                   â actual signal causing    â
           â                   â the termination.         â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "core-dump"       â A service process        â
           â                   â terminated abnormally    â
           â                   â with a signal and dumped â
           â                   â core. See $EXIT_CODE     â
           â                   â below for the signal     â
           â                   â causing the termination. â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "watchdog"        â Watchdog keep-alive ping â
           â                   â was enabled for the      â
           â                   â service, but the         â
           â                   â deadline was missed.     â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "exec-condition"  â Service did not run      â
           â                   â because ExecCondition=   â
           â                   â failed (that is its      â
           â                   â command exited with an   â
           â                   â exit status of 1 through â
           â                   â 254 (inclusive)).        â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "oom-kill"        â A service process was    â
           â                   â terminated by the        â
           â                   â Out-Of-Memory (OOM)      â
           â                   â killer.                  â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "start-limit-hit" â A start limit was        â
           â                   â defined for the unit and â
           â                   â it was hit, causing the  â
           â                   â unit to fail to start.   â
           â                   â See systemd.unit(5)'s    â
           â                   â StartLimitIntervalSec=   â
           â                   â and StartLimitBurst= for â
           â                   â details.                 â
           âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
           â "resources"       â A catch-all condition in â
           â                   â case a system operation  â
           â                   â failed.                  â
           âââââââââââââââââââââ´âââââââââââââââââââââââââââ
       ...
       $EXIT_CODE, $EXIT_STATUS
           ...
           â $SERVICE_RESULT   â $EXIT_CODE       â $EXIT_STATUS     â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "success"         â "killed"         â "HUP", "INT",    â
           â                   â                  â "TERM", "PIPE"   â
           â                   ââââââââââââââââââââ¼âââââââââââââââââââ¤
           â                   â "exited"         â "0"              â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "protocol"        â not set          â not set          â
           â                   ââââââââââââââââââââ¼âââââââââââââââââââ¤
           â                   â "exited"         â "0"              â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "timeout"         â "killed"         â "TERM", "KILL"   â
           â                   ââââââââââââââââââââ¼âââââââââââââââââââ¤
           â                   â "exited"         â "0", "1", "2",   â
           â                   â                  â "3", ..., "255"  â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "exit-code"       â "exited"         â "1", "2", "3",   â
           â                   â                  â ..., "255"       â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "signal"          â "killed"         â "HUP", "INT",    â
           â                   â                  â "KILL", ...      â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "core-dump"       â "dumped"         â "ABRT", "SEGV",  â
           â                   â                  â "QUIT", ...      â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "watchdog"        â "dumped"         â "ABRT"           â
           â                   ââââââââââââââââââââ¼âââââââââââââââââââ¤
           â                   â "killed"         â "TERM", "KILL"   â
           â                   ââââââââââââââââââââ¼âââââââââââââââââââ¤
           â                   â "exited"         â "0", "1", "2",   â
           â                   â                  â "3", ..., "255"  â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "exec-condition"  â "exited"         â "1", "2", "3",   â
           â                   â                  â "4", ..., "254"  â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "oom-kill"        â "killed"         â "TERM", "KILL"   â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "start-limit-hit" â not set          â not set          â
           âââââââââââââââââââââ¼âââââââââââââââââââ¼âââââââââââââââââââ¤
           â "resources"       â any of the above â any of the above â
           âââââââââââââââââââââ´âââââââââââââââââââ´âââââââââââââââââââ¤
           â Note: the process may be also terminated by a signal    â
           â not sent by systemd. In particular the process may send â
           â an arbitrary signal to itself in a handler for any of   â
           â the non-maskable signals. Nevertheless, in the          â
           â "timeout" and "watchdog" rows above only the signals    â
           â that systemd sends have been included. Moreover, using  â
           â SuccessExitStatus= additional exit statuses may be      â
           â declared to indicate clean termination, which is not    â
           â reflected by this table.                                â
           âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
## PROCESS EXIT CODES          top
       ...
       â Exit Code â Symbolic Name â Description        â
       âââââââââââââ¼ââââââââââââââââ¼âââââââââââââââââââââ¤
       â 0         â EXIT_SUCCESS  â Generic success    â
       â           â               â code.              â
       âââââââââââââ¼ââââââââââââââââ¼âââââââââââââââââââââ¤
       â 1         â EXIT_FAILURE  â Generic failure or â
       â           â               â unspecified error. â
       âââââââââââââ´ââââââââââââââââ´âââââââââââââââââââââ
       ...
       â Exit Code â Symbolic Name        â Description        â
       âââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââ¤
       â 2         â EXIT_INVALIDARGUMENT â Invalid or excess  â
       â           â                      â arguments.         â
       âââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââ¤
       â 3         â EXIT_NOTIMPLEMENTED  â Unimplemented      â
       â           â                      â feature.           â
       âââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââ¤
       â 4         â EXIT_NOPERMISSION    â The user has       â
       â           â                      â insufficient       â
       â           â                      â privileges.        â
       âââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââ¤
       â 5         â EXIT_NOTINSTALLED    â The program is not â
       â           â                      â installed.         â
       âââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââ¤
       â 6         â EXIT_NOTCONFIGURED   â The program is not â
       â           â                      â configured.        â
       âââââââââââââ¼âââââââââââââââââââââââ¼âââââââââââââââââââââ¤
       â 7         â EXIT_NOTRUNNING      â The program is not â
       â           â                      â running.           â
       âââââââââââââ´âââââââââââââââââââââââ´âââââââââââââââââââââ
       ...
       â Exit Code â Symbolic Name                â Description                                 â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 200       â EXIT_CHDIR                   â Changing to the                             â
       â           â                              â requested working                           â
       â           â                              â directory failed.                           â
       â           â                              â See                                         â
       â           â                              â WorkingDirectory=                           â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 201       â EXIT_NICE                    â Failed to set up                            â
       â           â                              â process scheduling                          â
       â           â                              â priority (nice                              â
       â           â                              â level). See Nice=                           â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 202       â EXIT_FDS                     â Failed to close                             â
       â           â                              â unwanted file                               â
       â           â                              â descriptors, or to                          â
       â           â                              â adjust passed file                          â
       â           â                              â descriptors.                                â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 203       â EXIT_EXEC                    â The actual process                          â
       â           â                              â execution failed                            â
       â           â                              â (specifically, the                          â
       â           â                              â execve(2) system                            â
       â           â                              â call). Most likely                          â
       â           â                              â this is caused by                           â
       â           â                              â a missing or                                â
       â           â                              â non-accessible                              â
       â           â                              â executable file.                            â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 204       â EXIT_MEMORY                  â Failed to perform                           â
       â           â                              â an action due to                            â
       â           â                              â memory shortage.                            â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 205       â EXIT_LIMITS                  â Failed to adjust                            â
       â           â                              â resource limits.                            â
       â           â                              â See LimitCPU= and                           â
       â           â                              â related settings                            â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 206       â EXIT_OOM_ADJUST              â Failed to adjust                            â
       â           â                              â the OOM setting.                            â
       â           â                              â See                                         â
       â           â                              â OOMScoreAdjust=                             â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 207       â EXIT_SIGNAL_MASK             â Failed to set                               â
       â           â                              â process signal                              â
       â           â                              â mask.                                       â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 208       â EXIT_STDIN                   â Failed to set up                            â
       â           â                              â standard input.                             â
       â           â                              â See StandardInput=                          â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 209       â EXIT_STDOUT                  â Failed to set up                            â
       â           â                              â standard output.                            â
       â           â                              â See                                         â
       â           â                              â StandardOutput=                             â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 210       â EXIT_CHROOT                  â Failed to change                            â
       â           â                              â root directory (â                           â
       â           â                              â chroot(2)). See                             â
       â           â                              â RootDirectory=/RootImage=                   â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 211       â EXIT_IOPRIO                  â Failed to set up IO                         â
       â           â                              â scheduling priority. See                    â
       â           â                              â IOSchedulingClass=/IOSchedulingPriority=    â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 212       â EXIT_TIMERSLACK              â Failed to set up timer slack. See           â
       â           â                              â TimerSlackNSec= above.                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 213       â EXIT_SECUREBITS              â Failed to set process secure bits. See      â
       â           â                              â SecureBits= above.                          â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 214       â EXIT_SETSCHEDULER            â Failed to set up CPU scheduling. See        â
       â           â                              â CPUSchedulingPolicy=/CPUSchedulingPriority= â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 215       â EXIT_CPUAFFINITY             â Failed to set up CPU affinity. See          â
       â           â                              â CPUAffinity= above.                         â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 216       â EXIT_GROUP                   â Failed to determine or change group         â
       â           â                              â credentials. See                            â
       â           â                              â Group=/SupplementaryGroups= above.          â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 217       â EXIT_USER                    â Failed to determine or change user          â
       â           â                              â credentials, or to set up user namespacing. â
       â           â                              â See User=/PrivateUsers= above.              â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 218       â EXIT_CAPABILITIES            â Failed to drop capabilities, or apply       â
       â           â                              â ambient capabilities. See                   â
       â           â                              â CapabilityBoundingSet=/AmbientCapabilities= â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 219       â EXIT_CGROUP                  â Setting up the service control group        â
       â           â                              â failed.                                     â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 220       â EXIT_SETSID                  â Failed to create new process session.       â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 221       â EXIT_CONFIRM                 â Execution has been cancelled by the user.   â
       â           â                              â See the systemd.confirm_spawn= kernel       â
       â           â                              â command line setting on                     â
       â           â                              â kernel-command-line(7) for details.         â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 222       â EXIT_STDERR                  â Failed to set up standard error output. See â
       â           â                              â StandardError= above.                       â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 224       â EXIT_PAM                     â Failed to set up PAM session. See PAMName=  â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 225       â EXIT_NETWORK                 â Failed to set up network namespacing. See   â
       â           â                              â PrivateNetwork= above.                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 226       â EXIT_NAMESPACE               â Failed to set up mount, UTS, or IPC         â
       â           â                              â namespacing. See ReadOnlyPaths=,            â
       â           â                              â ProtectHostname=, PrivateIPC=, and related  â
       â           â                              â settings above.                             â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 227       â EXIT_NO_NEW_PRIVILEGES       â Failed to disable new privileges. See       â
       â           â                              â NoNewPrivileges=yes above.                  â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 228       â EXIT_SECCOMP                 â Failed to apply system call filters. See    â
       â           â                              â SystemCallFilter= and related settings      â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 229       â EXIT_SELINUX_CONTEXT         â Determining or changing SELinux context     â
       â           â                              â failed. See SELinuxContext= above.          â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 230       â EXIT_PERSONALITY             â Failed to set up an execution domain        â
       â           â                              â (personality). See Personality= above.      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 231       â EXIT_APPARMOR_PROFILE        â Failed to prepare changing AppArmor         â
       â           â                              â profile. See AppArmorProfile= above.        â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 232       â EXIT_ADDRESS_FAMILIES        â Failed to restrict address families. See    â
       â           â                              â RestrictAddressFamilies= above.             â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 233       â EXIT_RUNTIME_DIRECTORY       â Setting up runtime directory failed. See    â
       â           â                              â RuntimeDirectory= and related settings      â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 235       â EXIT_CHOWN                   â Failed to adjust socket ownership. Used for â
       â           â                              â socket units only.                          â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 236       â EXIT_SMACK_PROCESS_LABEL     â Failed to set SMACK label. See              â
       â           â                              â SmackProcessLabel= above.                   â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 237       â EXIT_KEYRING                 â Failed to set up kernel keyring.            â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 238       â EXIT_STATE_DIRECTORY         â Failed to set up unit's state directory.    â
       â           â                              â See StateDirectory= above.                  â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 239       â EXIT_CACHE_DIRECTORY         â Failed to set up unit's cache directory.    â
       â           â                              â See CacheDirectory= above.                  â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 240       â EXIT_LOGS_DIRECTORY          â Failed to set up unit's logging directory.  â
       â           â                              â See LogsDirectory= above.                   â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 241       â EXIT_CONFIGURATION_DIRECTORY â Failed to set up unit's configuration       â
       â           â                              â directory. See ConfigurationDirectory=      â
       â           â                              â above.                                      â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 242       â EXIT_NUMA_POLICY             â Failed to set up unit's NUMA memory policy. â
       â           â                              â See NUMAPolicy= and NUMAMask= above.        â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 243       â EXIT_CREDENTIALS             â Failed to set up unit's credentials. See    â
       â           â                              â ImportCredential=, LoadCredential= and      â
       â           â                              â SetCredential= above.                       â
       âââââââââââââ¼âââââââââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââ¤
       â 245       â EXIT_BPF                     â Failed to apply BPF restrictions. See       â
       â           â                              â RestrictFileSystems= above.                 â
       âââââââââââââ´âââââââââââââââââââââââââââââââ´ââââââââââââââââââââââââââââââââââââââââââââââ
       ...
       â Exit Code â Symbolic Name  â Description        â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 64        â EX_USAGE       â Command line usage â
       â           â                â error              â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 65        â EX_DATAERR     â Data format error  â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 66        â EX_NOINPUT     â Cannot open input  â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 67        â EX_NOUSER      â Addressee unknown  â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 68        â EX_NOHOST      â Host name unknown  â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 69        â EX_UNAVAILABLE â Service            â
       â           â                â unavailable        â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 70        â EX_SOFTWARE    â internal software  â
       â           â                â error              â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 71        â EX_OSERR       â System error       â
       â           â                â (e.g., cannot      â
       â           â                â fork)              â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 72        â EX_OSFILE      â Critical OS file   â
       â           â                â missing            â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 73        â EX_CANTCREAT   â Cannot create      â
       â           â                â (user) output file â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 74        â EX_IOERR       â Input/output error â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 75        â EX_TEMPFAIL    â Temporary failure; â
       â           â                â user is invited to â
       â           â                â retry              â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 76        â EX_PROTOCOL    â Remote error in    â
       â           â                â protocol           â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 77        â EX_NOPERM      â Permission denied  â
       âââââââââââââ¼âââââââââââââââââ¼âââââââââââââââââââââ¤
       â 78        â EX_CONFIG      â Configuration      â
       â           â                â error              â
       âââââââââââââ´âââââââââââââââââ´âââââââââââââââââââââ
