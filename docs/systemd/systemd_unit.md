# Source: https://man7.org/linux/man-pages/man5/systemd.unit.5.html
...
## DESCRIPTION          top
       ...
       systemd-networkd.service. As another example, default.target â the
       default system target started at boot â is commonly aliased to
       ...
       "alias@inst.service") may be a symlink to different template (e.g.
       "template@inst.service"). In that case, just this specific
       instance is aliased, while other instances of the template (e.g.
       "alias@foo.service", "alias@bar.service") are not aliased. Those
       ...
       getty@tty3.service is requested and no file by that name is found,
       systemd will look for getty@.service and instantiate a service
       ...
       Files (including directories) with names that match certain
       patterns are generally ignored. This includes names that start
       with a "."  or end with a ".ignore".
...
## UNIT FILE LOAD PATH          top
       ...
       âââââââââââââââââââââââââââââââââ¤ configuration created    â
       ...
       ââââââââââââââââââââââââââââââââââââââââââââ¤ ($XDG_CONFIG_HOME is     â
       ...
       /etc/systemd/system/alias1.service â service1.service,
       /etc/systemd/system/alias2.service â
       /usr/lib/systemd/service1.service,
       /etc/systemd/system/alias3.service â
       ...
       symlink /etc/systemd/system/link1.service â ../link1_service_file
...
## [UNIT] SECTION OPTIONS          top
       ...
       Requires=
           ...
           ConditionPathExists=, ConditionPathIsSymbolicLink=, ... â see
       ...
       BindsTo=
           ...
           addition to the effects of Requires=, which already stops (or
           restarts) the configuring unit when a listed unit is
           explicitly stopped (or restarted), it also does so when a
           listed unit stops unexpectedly (which includes when it fails).
           Units can suddenly, unexpectedly enter inactive state for
           ...
           ConditionPathIsSymbolicLink=, ... â see below) will be
       ...
       PartOf=
           ...
           this unit. Note that this is a one-way dependency â changes to
       ...
       CollectMode=
           ...
           not referenced by clients, jobs or other units â however it is
   ...
   Conditions and Asserts
       ...
       ConditionFirmware=
           ...
           â¢   "uefi" matches systems with EFI.

           â¢   "device-tree" matches systems with a device tree.

           â¢   "device-tree-compatible(value)" matches systems with a
               device tree that are compatible with "value".

           â¢   "smbios-field(field operator value)" matches systems with
       ...
       ConditionKernelCommandLine=
           ...
           with the exclamation mark â unset). The argument must either
       ...
       ConditionEnvironment=
           ...
           exclamation mark â unset) in the service manager's environment
       ...
       ConditionSecurity=
           ...
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â selinux         â SELinux MAC                â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â apparmor        â AppArmor MAC               â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â tomoyo          â Tomoyo MAC                 â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â smack           â SMACK MAC                  â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â ima             â Integrity Measurement      â
           â                 â Architecture (IMA)         â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â audit           â Linux Audit Framework      â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â uefi-secureboot â UEFI SecureBoot            â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â tpm2            â Trusted Platform Module    â
           â                 â 2.0 (TPM2) (with full      â
           â                 â UEFI support, including    â
           â                 â the TCG PC Client          â
           â                 â                   Platform â
           â                 â Firmware Profile)          â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â cvm             â Confidential virtual       â
           â                 â machine (SEV/TDX)          â
           âââââââââââââââââââ¼âââââââââââââââââââââââââââââ¤
           â measured-uki    â Unified Kernel Image with  â
           â                 â PCR 11 Measurements, as    â
           â                 â per systemd-stub(7). Added â
           â                 â in version 255.            â
           âââââââââââââââââââ´âââââââââââââââââââââââââââââ
...
## MAPPING OF UNIT PROPERTIES TO THEIR INVERSES          top
       ...
       â "Forward"             â "Reverse"             â Where used                    â
       â property              â property              â                               â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââ¤
       â Before=               â After=                â                               â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¤ [Unit] section                â
       â After=                â Before=               â                               â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ¬âââââââââââââââ¤
       â Requires=             â RequiredBy=           â [Unit] section â [Install]    â
       â                       â                       â                â section      â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââ¤
       â Wants=                â WantedBy=             â [Unit] section â [Install]    â
       â                       â                       â                â section      â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââ¤
       â Upholds=              â UpheldBy=             â [Unit] section â [Install]    â
       â                       â                       â                â section      â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââ¤
       â PartOf=               â ConsistsOf=           â [Unit] section â an automatic â
       â                       â                       â                â property     â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââ¤
       â BindsTo=              â BoundBy=              â [Unit] section â an automatic â
       â                       â                       â                â property     â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââ¤
       â Requisite=            â RequisiteOf=          â [Unit] section â an automatic â
       â                       â                       â                â property     â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ¼âââââââââââââââ¤
       â Conflicts=            â ConflictedBy=         â [Unit] section â an automatic â
       â                       â                       â                â property     â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ´âââââââââââââââ¤
       â Triggers=             â TriggeredBy=          â Automatic properties, see     â
       â                       â                       â notes below                   â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââ¤
       â PropagatesReloadTo=   â ReloadPropagatedFrom= â                               â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¤ [Unit] section                â
       â ReloadPropagatedFrom= â PropagatesReloadTo=   â                               â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââ¤
       â PropagatesStopTo=     â StopPropagatedFrom=   â                               â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¤ [Unit] section                â
       â StopPropagatedFrom=   â PropagatesStopTo=     â                               â
       âââââââââââââââââââââââââ¼ââââââââââââââââââââââââ¼âââââââââââââââââ¬âââââââââââââââ¤
       â Following=            â n/a                   â An automatic   â              â
       â                       â                       â property       â              â
       âââââââââââââââââââââââââ´ââââââââââââââââââââââââ´âââââââââââââââââ´âââââââââââââââ
...
## SPECIFIERS          top
       ...
       â Specifier â Meaning            â Details                  â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%a"      â Architecture       â A short string           â
       â           â                    â identifying the          â
       â           â                    â architecture of          â
       â           â                    â the local system.        â
       â           â                    â A string such as         â
       â           â                    â x86, x86-64 or           â
       â           â                    â arm64. See the           â
       â           â                    â architectures            â
       â           â                    â defined for              â
       â           â                    â ConditionArchitecture=   â
       â           â                    â above for a full         â
       â           â                    â list.                    â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%A"      â Operating system   â The operating system     â
       â           â image version      â image version            â
       â           â                    â identifier of the        â
       â           â                    â running system, as       â
       â           â                    â read from the            â
       â           â                    â IMAGE_VERSION= field     â
       â           â                    â of /etc/os-release. If   â
       â           â                    â not set, resolves to     â
       â           â                    â an empty string. See     â
       â           â                    â os-release(5) for more   â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%b"      â Boot ID            â The boot ID of the       â
       â           â                    â running system,          â
       â           â                    â formatted as string.     â
       â           â                    â See random(4) for more   â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%B"      â Operating system   â The operating system     â
       â           â build ID           â build identifier of      â
       â           â                    â the running system, as   â
       â           â                    â read from the            â
       â           â                    â BUILD_ID= field of       â
       â           â                    â /etc/os-release. If      â
       â           â                    â not set, resolves to     â
       â           â                    â an empty string. See     â
       â           â                    â os-release(5) for more   â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%C"      â Cache directory    â This is either           â
       â           â root               â /var/cache (for the      â
       â           â                    â system manager) or the   â
       â           â                    â path "$XDG_CACHE_HOME"   â
       â           â                    â resolves to (for user    â
       â           â                    â managers).               â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%d"      â Credentials        â This is the value of     â
       â           â directory          â the                      â
       â           â                    â "$CREDENTIALS_DIRECTORY" â
       â           â                    â environment variable     â
       â           â                    â if available. See        â
       â           â                    â section "Credentials"    â
       â           â                    â in systemd.exec(5) for   â
       â           â                    â more information.        â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%D"      â Shared data        â This is either           â
       â           â directory          â /usr/share/ (for the     â
       â           â                    â system manager) or the   â
       â           â                    â path "$XDG_DATA_HOME"    â
       â           â                    â resolves to (for user    â
       â           â                    â managers).               â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%E"      â Configuration      â This is either /etc/     â
       â           â directory root     â (for the system manager) â
       â           â                    â or the path              â
       â           â                    â "$XDG_CONFIG_HOME"       â
       â           â                    â resolves to (for user    â
       â           â                    â managers).               â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%f"      â Unescaped filename â This is either the       â
       â           â                    â unescaped instance name  â
       â           â                    â (if applicable) with /   â
       â           â                    â prepended (if            â
       â           â                    â applicable), or the      â
       â           â                    â unescaped prefix name    â
       â           â                    â prepended with /. This   â
       â           â                    â implements unescaping    â
       â           â                    â according to the rules   â
       â           â                    â for escaping absolute    â
       â           â                    â file system paths        â
       â           â                    â discussed above.         â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%g"      â User group         â This is the name of the  â
       â           â                    â group running the        â
       â           â                    â service manager          â
       â           â                    â instance. In case of the â
       â           â                    â system manager this      â
       â           â                    â resolves to "root".      â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%G"      â User GID           â This is the numeric GID  â
       â           â                    â of the user running the  â
       â           â                    â service manager          â
       â           â                    â instance. In case of the â
       â           â                    â system manager this      â
       â           â                    â resolves to "0".         â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%h"      â User home          â This is the home         â
       â           â directory          â directory of the user    â
       â           â                    â running the service      â
       â           â                    â manager instance. In     â
       â           â                    â case of the system       â
       â           â                    â manager this resolves to â
       â           â                    â "/root".                 â
       â           â                    â                          â
       â           â                    â Note that this setting   â
       â           â                    â is not influenced by the â
       â           â                    â User= setting            â
       â           â                    â configurable in the      â
       â           â                    â [Service] section of the â
       â           â                    â service unit.            â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%H"      â Host name          â The hostname of the      â
       â           â                    â running system at the    â
       â           â                    â point in time the unit   â
       â           â                    â configuration is loaded. â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%i"      â Instance name      â For instantiated units   â
       â           â                    â this is the string       â
       â           â                    â between the first "@"    â
       â           â                    â character and the type   â
       â           â                    â suffix. Empty for        â
       â           â                    â non-instantiated units.  â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%I"      â Unescaped instance â Same as "%i", but with   â
       â           â name               â escaping undone.         â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%j"      â Final component of â This is the string       â
       â           â the prefix         â between the last "-" and â
       â           â                    â the end of the prefix    â
       â           â                    â name. If there is no     â
       â           â                    â "-", this is the same as â
       â           â                    â "%p".                    â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%J"      â Unescaped final    â Same as "%j", but with   â
       â           â component of the   â escaping undone.         â
       â           â prefix             â                          â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%l"      â Short host name    â The hostname of the      â
       â           â                    â running system at the    â
       â           â                    â point in time the unit   â
       â           â                    â configuration is loaded, â
       â           â                    â truncated at the first   â
       â           â                    â dot to remove any domain â
       â           â                    â component.               â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%L"      â Log directory root â This is either /var/log  â
       â           â                    â (for the system manager) â
       â           â                    â or the path              â
       â           â                    â $XDG_STATE_HOME resolves â
       â           â                    â to with /log appended    â
       â           â                    â (for user managers).     â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%m"      â Machine ID         â The machine ID of the    â
       â           â                    â running system,          â
       â           â                    â formatted as string. See â
       â           â                    â machine-id(5) for more   â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%M"      â Operating system   â The operating system     â
       â           â image identifier   â image identifier of the  â
       â           â                    â running system, as read  â
       â           â                    â from the IMAGE_ID= field â
       â           â                    â of /etc/os-release. If   â
       â           â                    â not set, resolves to an  â
       â           â                    â empty string. See        â
       â           â                    â os-release(5) for more   â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%n"      â Full unit name     â                          â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%N"      â Full unit name     â Same as "%n", but with   â
       â           â                    â the type suffix removed. â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%o"      â Operating system   â The operating system     â
       â           â ID                 â identifier of the        â
       â           â                    â running system, as read  â
       â           â                    â from the ID= field of    â
       â           â                    â /etc/os-release. See     â
       â           â                    â os-release(5) for more   â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%p"      â Prefix name        â For instantiated units,  â
       â           â                    â this refers to the       â
       â           â                    â string before the first  â
       â           â                    â "@" character of the     â
       â           â                    â unit name. For           â
       â           â                    â non-instantiated units,  â
       â           â                    â same as "%N".            â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%P"      â Unescaped prefix   â Same as "%p", but with   â
       â           â name               â escaping undone.         â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%q"      â Pretty host name   â The pretty hostname of   â
       â           â                    â the running system at    â
       â           â                    â the point in time the    â
       â           â                    â unit configuration is    â
       â           â                    â loaded, as read from the â
       â           â                    â PRETTY_HOSTNAME= field   â
       â           â                    â of /etc/machine-info. If â
       â           â                    â not set, resolves to the â
       â           â                    â short hostname. See      â
       â           â                    â machine-info(5) for more â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%s"      â User shell         â This is the shell of the â
       â           â                    â user running the service â
       â           â                    â manager instance.        â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%S"      â State directory    â This is either /var/lib  â
       â           â root               â (for the system manager) â
       â           â                    â or the path              â
       â           â                    â $XDG_STATE_HOME resolves â
       â           â                    â to (for user managers).  â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%t"      â Runtime directory  â This is either /run/     â
       â           â root               â (for the system manager) â
       â           â                    â or the path              â
       â           â                    â "$XDG_RUNTIME_DIR"       â
       â           â                    â resolves to (for user    â
       â           â                    â managers).               â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%T"      â Directory for      â This is either /tmp or   â
       â           â temporary files    â the path "$TMPDIR",      â
       â           â                    â "$TEMP" or "$TMP" are    â
       â           â                    â set to. (Note that the   â
       â           â                    â directory may be         â
       â           â                    â specified without a      â
       â           â                    â trailing slash.)         â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%u"      â User name          â This is the name of the  â
       â           â                    â user running the service â
       â           â                    â manager instance. In     â
       â           â                    â case of the system       â
       â           â                    â manager this resolves to â
       ...
       â           â                    â service unit.            â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%U"      â User UID           â This is the numeric UID  â
       â           â                    â of the user running the  â
       â           â                    â service manager          â
       â           â                    â instance. In case of the â
       â           â                    â system manager this      â
       ...
       â           â                    â service unit.            â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%v"      â Kernel release     â Identical to uname -r    â
       â           â                    â output.                  â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%V"      â Directory for      â This is either /var/tmp  â
       â           â larger and         â or the path "$TMPDIR",   â
       â           â persistent         â "$TEMP" or "$TMP" are    â
       â           â temporary files    â set to. (Note that the   â
       â           â                    â directory may be         â
       â           â                    â specified without a      â
       â           â                    â trailing slash.)         â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%w"      â Operating system   â The operating system     â
       â           â version ID         â version identifier of    â
       â           â                    â the running system, as   â
       â           â                    â read from the            â
       â           â                    â VERSION_ID= field of     â
       â           â                    â /etc/os-release. If not  â
       â           â                    â set, resolves to an      â
       â           â                    â empty string. See        â
       â           â                    â os-release(5) for more   â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%W"      â Operating system   â The operating system     â
       â           â variant ID         â variant identifier of    â
       â           â                    â the running system, as   â
       â           â                    â read from the            â
       â           â                    â VARIANT_ID= field of     â
       â           â                    â /etc/os-release. If not  â
       â           â                    â set, resolves to an      â
       â           â                    â empty string. See        â
       â           â                    â os-release(5) for more   â
       â           â                    â information.             â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%y"      â The path to the    â This is the path where   â
       â           â fragment           â the main part of the     â
       â           â                    â unit file is located.    â
       â           â                    â For linked unit files,   â
       â           â                    â the real path outside of â
       â           â                    â the unit search          â
       â           â                    â directories is used. For â
       â           â                    â units that do not have a â
       â           â                    â fragment file, this      â
       â           â                    â specifier will raise an  â
       â           â                    â error.                   â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%Y"      â The directory of   â This is the directory    â
       â           â the fragment       â part of "%y".            â
       âââââââââââââ¼âââââââââââââââââââââ¼âââââââââââââââââââââââââââ¤
       â "%%"      â Single percent     â Use "%%" in place of "%" â
       â           â sign               â to specify a single      â
       â           â                    â percent sign.            â
       âââââââââââââ´âââââââââââââââââââââ´âââââââââââââââââââââââââââ
...
## NOTES          top
        ...
        2. ð£ð¥ð§¨ð¥ð¥ð£ Please note that those configuration files must
...
systemd 260~devel                                         SYSTEMD.UNIT(5)
