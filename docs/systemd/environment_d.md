# Source: https://man7.org/linux/man-pages/man5/environment.d.5.html
...
NAME | SYNOPSIS | DESCRIPTION | CONFIGURATION DIRECTORIES AND PRECEDENCE | CONFIGURATION FORMAT | APPLICABILITY | SEE ALSO | NOTES | COLOPHON
...
## NOTES          top
        ...
        1. ð£ð¥ð§¨ð¥ð¥ð£ Please note that those configuration files must
...
systemd 260~devel                                        ENVIRONMENT.D(5)
