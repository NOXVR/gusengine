...
Readline | Node.js v25.6.1 Documentation
...
- [25.x](https://nodejs.org/docs/latest-v25.x/api/readline.html)

- [24.x LTS](https://nodejs.org/docs/latest-v24.x/api/readline.html)

- [23.x](https://nodejs.org/docs/latest-v23.x/api/readline.html)

- [22.x LTS](https://nodejs.org/docs/latest-v22.x/api/readline.html)

- [21.x](https://nodejs.org/docs/latest-v21.x/api/readline.html)

- [20.x LTS](https://nodejs.org/docs/latest-v20.x/api/readline.html)

- [19.x](https://nodejs.org/docs/latest-v19.x/api/readline.html)

- [18.x](https://nodejs.org/docs/latest-v18.x/api/readline.html)

- [17.x](https://nodejs.org/docs/latest-v17.x/api/readline.html)

- [16.x](https://nodejs.org/docs/latest-v16.x/api/readline.html)

- [15.x](https://nodejs.org/docs/latest-v15.x/api/readline.html)

- [14.x](https://nodejs.org/docs/latest-v14.x/api/readline.html)

- [13.x](https://nodejs.org/docs/latest-v13.x/api/readline.html)

- [12.x](https://nodejs.org/docs/latest-v12.x/api/readline.html)

- [11.x](https://nodejs.org/docs/latest-v11.x/api/readline.html)

- [10.x](https://nodejs.org/docs/latest-v10.x/api/readline.html)

- [9.x](https://nodejs.org/docs/latest-v9.x/api/readline.html)

- [8.x](https://nodejs.org/docs/latest-v8.x/api/readline.html)

- [7.x](https://nodejs.org/docs/latest-v7.x/api/readline.html)

- [6.x](https://nodejs.org/docs/latest-v6.x/api/readline.html)

- [5.x](https://nodejs.org/docs/latest-v5.x/api/readline.html)

- [4.x](https://nodejs.org/docs/latest-v4.x/api/readline.html)

- [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/readline.html)

- [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/readline.html)
...
**Source Code:** [lib/readline.js](https://github.com/nodejs/node/blob/v25.6.1/lib/readline.js)
...
- Extends: [<readline.InterfaceConstructor>](readline.html#class-interfaceconstructor)
...
The class `readline.Interface` now inherits from `Interface`.
...
- `interface` [<readline.InterfaceConstructor>](readline.html#class-interfaceconstructor)
