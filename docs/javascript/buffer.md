...
Buffer | Node.js v25.6.1 Documentation
...
- [25.x](https://nodejs.org/docs/latest-v25.x/api/buffer.html)

- [24.x LTS](https://nodejs.org/docs/latest-v24.x/api/buffer.html)

- [23.x](https://nodejs.org/docs/latest-v23.x/api/buffer.html)

- [22.x LTS](https://nodejs.org/docs/latest-v22.x/api/buffer.html)

- [21.x](https://nodejs.org/docs/latest-v21.x/api/buffer.html)

- [20.x LTS](https://nodejs.org/docs/latest-v20.x/api/buffer.html)

- [19.x](https://nodejs.org/docs/latest-v19.x/api/buffer.html)

- [18.x](https://nodejs.org/docs/latest-v18.x/api/buffer.html)

- [17.x](https://nodejs.org/docs/latest-v17.x/api/buffer.html)

- [16.x](https://nodejs.org/docs/latest-v16.x/api/buffer.html)

- [15.x](https://nodejs.org/docs/latest-v15.x/api/buffer.html)

- [14.x](https://nodejs.org/docs/latest-v14.x/api/buffer.html)

- [13.x](https://nodejs.org/docs/latest-v13.x/api/buffer.html)

- [12.x](https://nodejs.org/docs/latest-v12.x/api/buffer.html)

- [11.x](https://nodejs.org/docs/latest-v11.x/api/buffer.html)

- [10.x](https://nodejs.org/docs/latest-v10.x/api/buffer.html)

- [9.x](https://nodejs.org/docs/latest-v9.x/api/buffer.html)

- [8.x](https://nodejs.org/docs/latest-v8.x/api/buffer.html)

- [7.x](https://nodejs.org/docs/latest-v7.x/api/buffer.html)

- [6.x](https://nodejs.org/docs/latest-v6.x/api/buffer.html)

- [5.x](https://nodejs.org/docs/latest-v5.x/api/buffer.html)

- [4.x](https://nodejs.org/docs/latest-v4.x/api/buffer.html)

- [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/buffer.html)

- [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/buffer.html)
...
**Source Code:** [lib/buffer.js](https://github.com/nodejs/node/blob/v25.6.1/lib/buffer.js)
...
instances. All [<TypedArray>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) methods and properties are available on `Buffer`s. There are,
...
- `fill` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) | [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) A value to pre-fill the new `Buffer`
with. **Default:** `0`.
...
The arguments can now be `Uint8Array`s.

v0.11.13

Added in: v0.11.13

- `buf1` [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)

- `buf2` [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
...
The elements of `list` can now be `Uint8Array`s.

v0.7.11

Added in: v0.7.11

- `list` [<Buffer[]>](buffer.html#class-buffer) | [<Uint8Array[]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) List of `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
...
- `buffer` [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) An existing `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) from
which to copy data.
...
- `target` [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) A `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) with which to
compare `buf`.
...
- `target` [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) A `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) to copy into.
...
- `otherBuffer` [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) A `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) with which to
compare `buf`.
...
- `value` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) | [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) The value with which to fill `buf`.
...
supports Uint8Array as `this` value.
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use [`buf.buffer`](#bufbuffer) instead.
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use [`buf.subarray`](#bufsubarraystart-end) instead.
...
- `value` [<bigint>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#bigint_type) Number to be written to `buf`.
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use [`Buffer.from(array)`](#static-method-bufferfromarray) instead.
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use
[`Buffer.from(arrayBuffer[, byteOffset[, length]])`](#static-method-bufferfromarraybuffer-byteoffset-length)
instead.
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use [`Buffer.from(buffer)`](#static-method-bufferfrombuffer) instead.
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use [`Buffer.alloc()`](#static-method-bufferallocsize-fill-encoding) instead (also see
...
- `sources` [<string[]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<ArrayBuffer[]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) | [<TypedArray[]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [<DataView[]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) | [<Blob[]>](buffer.html#class-blob) | [<File[]>](buffer.html#class-file)
An array of string, [<ArrayBuffer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer), [<TypedArray>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray), [<DataView>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView), [<File>](buffer.html#class-file), or [<Blob>](buffer.html#class-blob)
...
- `input` [<Buffer>](buffer.html#class-buffer) | [<ArrayBuffer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) | [<TypedArray>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) The input to validate.
...
- `source` [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) A `Buffer` or `Uint8Array` instance.
...
Value is changed to 253 - 1 on 64-bit architectures, and 231 - 1 on 32-bit architectures.
