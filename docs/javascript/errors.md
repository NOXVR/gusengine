...
Errors | Node.js v25.6.1 Documentation
...
- [25.x](https://nodejs.org/docs/latest-v25.x/api/errors.html)

- [24.x LTS](https://nodejs.org/docs/latest-v24.x/api/errors.html)

- [23.x](https://nodejs.org/docs/latest-v23.x/api/errors.html)

- [22.x LTS](https://nodejs.org/docs/latest-v22.x/api/errors.html)

- [21.x](https://nodejs.org/docs/latest-v21.x/api/errors.html)

- [20.x LTS](https://nodejs.org/docs/latest-v20.x/api/errors.html)

- [19.x](https://nodejs.org/docs/latest-v19.x/api/errors.html)

- [18.x](https://nodejs.org/docs/latest-v18.x/api/errors.html)

- [17.x](https://nodejs.org/docs/latest-v17.x/api/errors.html)

- [16.x](https://nodejs.org/docs/latest-v16.x/api/errors.html)

- [15.x](https://nodejs.org/docs/latest-v15.x/api/errors.html)

- [14.x](https://nodejs.org/docs/latest-v14.x/api/errors.html)

- [13.x](https://nodejs.org/docs/latest-v13.x/api/errors.html)

- [12.x](https://nodejs.org/docs/latest-v12.x/api/errors.html)

- [11.x](https://nodejs.org/docs/latest-v11.x/api/errors.html)

- [10.x](https://nodejs.org/docs/latest-v10.x/api/errors.html)

- [9.x](https://nodejs.org/docs/latest-v9.x/api/errors.html)

- [8.x](https://nodejs.org/docs/latest-v8.x/api/errors.html)

- [7.x](https://nodejs.org/docs/latest-v7.x/api/errors.html)

- [6.x](https://nodejs.org/docs/latest-v6.x/api/errors.html)

- [5.x](https://nodejs.org/docs/latest-v5.x/api/errors.html)

- [4.x](https://nodejs.org/docs/latest-v4.x/api/errors.html)
...
error object, such as a [<Proxy>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Proxy).
...
constructor or the legacy [`url.parse()`](url.html#urlparseurlstring-parsequerystring-slashesdenotehost) to be parsed.
...
When `strict` set to `true`, thrown by [`util.parseArgs()`](util.html#utilparseargsconfig) if a [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type)
...
[Stability: 0](documentation.html#stability-index) - Deprecated. These error codes are either inconsistent, or have
been removed.
