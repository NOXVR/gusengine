...
Net | Node.js v25.6.1 Documentation
...
- [25.x](https://nodejs.org/docs/latest-v25.x/api/net.html)

- [24.x LTS](https://nodejs.org/docs/latest-v24.x/api/net.html)

- [23.x](https://nodejs.org/docs/latest-v23.x/api/net.html)

- [22.x LTS](https://nodejs.org/docs/latest-v22.x/api/net.html)

- [21.x](https://nodejs.org/docs/latest-v21.x/api/net.html)

- [20.x LTS](https://nodejs.org/docs/latest-v20.x/api/net.html)

- [19.x](https://nodejs.org/docs/latest-v19.x/api/net.html)

- [18.x](https://nodejs.org/docs/latest-v18.x/api/net.html)

- [17.x](https://nodejs.org/docs/latest-v17.x/api/net.html)

- [16.x](https://nodejs.org/docs/latest-v16.x/api/net.html)

- [15.x](https://nodejs.org/docs/latest-v15.x/api/net.html)

- [14.x](https://nodejs.org/docs/latest-v14.x/api/net.html)

- [13.x](https://nodejs.org/docs/latest-v13.x/api/net.html)

- [12.x](https://nodejs.org/docs/latest-v12.x/api/net.html)

- [11.x](https://nodejs.org/docs/latest-v11.x/api/net.html)

- [10.x](https://nodejs.org/docs/latest-v10.x/api/net.html)

- [9.x](https://nodejs.org/docs/latest-v9.x/api/net.html)

- [8.x](https://nodejs.org/docs/latest-v8.x/api/net.html)

- [7.x](https://nodejs.org/docs/latest-v7.x/api/net.html)

- [6.x](https://nodejs.org/docs/latest-v6.x/api/net.html)

- [5.x](https://nodejs.org/docs/latest-v5.x/api/net.html)

- [4.x](https://nodejs.org/docs/latest-v4.x/api/net.html)

- [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/net.html)

- [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/net.html)
...
- 
                    [View as JSON](net.json)
                  
                  
- [Edit on GitHub](https://github.com/nodejs/node/edit/main/doc/api/net.md)    
...
**Source Code:** [lib/net.js](https://github.com/nodejs/node/blob/v25.6.1/lib/net.js)
...
- `address` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<net.SocketAddress>](net.html#class-netsocketaddress) An IPv4 or IPv6 address.
...
- `start` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<net.SocketAddress>](net.html#class-netsocketaddress) The starting IPv4 or IPv6 address in the
range.

- `end` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<net.SocketAddress>](net.html#class-netsocketaddress) The ending IPv4 or IPv6 address in the range.
...
- `net` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<net.SocketAddress>](net.html#class-netsocketaddress) The network IPv4 or IPv6 address.
...
- `address` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<net.SocketAddress>](net.html#class-netsocketaddress) The IP address to check
...
- `input` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) An input string containing an IP address and optional port,
...
- `backlog` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Common parameter of [`server.listen()`](#serverlisten) functions
...
- `backlog` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Common parameter of [`server.listen()`](#serverlisten)
functions.
...
- `reusePort` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) For TCP servers, setting `reusePort` to `true` allows
...
Setting `maxConnections` to `0` drops all the incoming connections. Previously, it was interpreted as `Infinity`.
...
If the process is running in cluster mode, Node.js will, by default, route the connection to another worker process. To close the connection instead, set [`server.dropMaxConnection`](#serverdropmaxconnection) to `true`.
...
- `keepAlive` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If set to `true`, it enables keep-alive functionality on
the socket immediately after the connection is established, similarly on what
is done in [`socket.setKeepAlive()`](#socketsetkeepaliveenable-initialdelay). **Default:** `false`.
...
- `noDelay` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If set to `true`, it disables the use of Nagle's algorithm
...
- `buffer` [<Buffer>](buffer.html#class-buffer) | [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) | [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) Either a reusable chunk of memory to
...
- `typeOfService` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) The initial Type of Service (TOS) value.
...
- Type: [<Buffer>](buffer.html#class-buffer) | [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type)
...
- `err` [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) | [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) The error object. See [`dns.lookup()`](dns.html#dnslookuphostname-options-callback).

- `address` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) The IP address.

- `family` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) | [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) The address type. See [`dns.lookup()`](dns.html#dnslookuphostname-options-callback).
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use [`writable.writableLength`](stream.html#writablewritablelength) instead.
...
The default value for the autoSelectFamily option is now true. The `--enable-network-family-autoselection` CLI flag has been renamed to `--network-family-autoselection`. The old name is now an alias but it is discouraged.
...
- `connectListener` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) Common parameter of [`socket.connect()`](#socketconnect)
...
- `autoSelectFamily` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type): If set to `true`, it enables a family
...
- `autoSelectFamilyAttemptTimeout` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type): The amount of time in milliseconds
...
- Type: [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Indicates if the connection is destroyed or not. Once a
...
- Returns: [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) The current TOS value.
...
- `tos` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) The TOS value to set (0-255).
...
- `highWaterMark` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Optionally overrides all [`net.Socket`](#class-netsocket)s'
...
similarly on what is done in [`socket.setKeepAlive()`](#socketsetkeepaliveenable-initialdelay). **Default:**
`false`.
...
- `value` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) The new default value.
The initial default value is `true`, unless the command line option
`--no-network-family-autoselection` is provided.
