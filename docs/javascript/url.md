...
URL | Node.js v25.6.1 Documentation
...
- [25.x](https://nodejs.org/docs/latest-v25.x/api/url.html)

- [24.x LTS](https://nodejs.org/docs/latest-v24.x/api/url.html)

- [23.x](https://nodejs.org/docs/latest-v23.x/api/url.html)

- [22.x LTS](https://nodejs.org/docs/latest-v22.x/api/url.html)

- [21.x](https://nodejs.org/docs/latest-v21.x/api/url.html)

- [20.x LTS](https://nodejs.org/docs/latest-v20.x/api/url.html)

- [19.x](https://nodejs.org/docs/latest-v19.x/api/url.html)

- [18.x](https://nodejs.org/docs/latest-v18.x/api/url.html)

- [17.x](https://nodejs.org/docs/latest-v17.x/api/url.html)

- [16.x](https://nodejs.org/docs/latest-v16.x/api/url.html)

- [15.x](https://nodejs.org/docs/latest-v15.x/api/url.html)

- [14.x](https://nodejs.org/docs/latest-v14.x/api/url.html)

- [13.x](https://nodejs.org/docs/latest-v13.x/api/url.html)

- [12.x](https://nodejs.org/docs/latest-v12.x/api/url.html)

- [11.x](https://nodejs.org/docs/latest-v11.x/api/url.html)

- [10.x](https://nodejs.org/docs/latest-v10.x/api/url.html)

- [9.x](https://nodejs.org/docs/latest-v9.x/api/url.html)

- [8.x](https://nodejs.org/docs/latest-v8.x/api/url.html)

- [7.x](https://nodejs.org/docs/latest-v7.x/api/url.html)

- [6.x](https://nodejs.org/docs/latest-v6.x/api/url.html)

- [5.x](https://nodejs.org/docs/latest-v5.x/api/url.html)

- [4.x](https://nodejs.org/docs/latest-v4.x/api/url.html)

- [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/url.html)

- [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/url.html)
...
- 
                    [View as JSON](url.json)
                  
                  
- [Edit on GitHub](https://github.com/nodejs/node/edit/main/doc/api/url.md)    
...
**Source Code:** [lib/url.js](https://github.com/nodejs/node/blob/v25.6.1/lib/url.js)
...
const myURL =
  url.parse('https://user:pass@sub.example.com:8080/p/a/t/h?query=string#hash');copy
...
protocolport"ftp"21"file""http"80"https"443"ws"80"wss"443
...
The data stored by the registered [<Blob>](buffer.html#class-blob) will be retained in memory until
...
- Returns: [<URL>](url.html#the-whatwg-url-api) | [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type)
...
is similar to [<Map>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map)'s constructor. `iterable` can be an `Array` or any
...
The `options` argument can now be used to determine how to parse the `path` argument.

v10.12.0

Added in: v10.12.0

- `url` [<URL>](url.html#the-whatwg-url-api) | [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) The file URL string or URL object to convert to a path.

- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)

- `windows` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) | [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) `true` if the `path` should be
...
The `options` argument can now be used to determine how to return the `path` value.
...
[Stability: 3](documentation.html#stability-index) - Legacy: Use the WHATWG URL API instead.
...
- `urlObject` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) A URL object (as returned by `url.parse()` or
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use the WHATWG URL API instead.

- `urlString` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) A string that will be passed to `url.parse()` and then
formatted.

`url.format(urlString)` is shorthand for `url.format(url.parse(urlString))`.

Because it invokes the deprecated [`url.parse()`](#urlparseurlstring-parsequerystring-slashesdenotehost), passing a string argument
...
console.log(formatted); // Prints: http://[fe80::1]/a/b?a=b#abccopy
