...
Child process | Node.js v25.6.1 Documentation
...
- [25.x](https://nodejs.org/docs/latest-v25.x/api/child_process.html)

- [24.x LTS](https://nodejs.org/docs/latest-v24.x/api/child_process.html)

- [23.x](https://nodejs.org/docs/latest-v23.x/api/child_process.html)

- [22.x LTS](https://nodejs.org/docs/latest-v22.x/api/child_process.html)

- [21.x](https://nodejs.org/docs/latest-v21.x/api/child_process.html)

- [20.x LTS](https://nodejs.org/docs/latest-v20.x/api/child_process.html)

- [19.x](https://nodejs.org/docs/latest-v19.x/api/child_process.html)

- [18.x](https://nodejs.org/docs/latest-v18.x/api/child_process.html)

- [17.x](https://nodejs.org/docs/latest-v17.x/api/child_process.html)

- [16.x](https://nodejs.org/docs/latest-v16.x/api/child_process.html)

- [15.x](https://nodejs.org/docs/latest-v15.x/api/child_process.html)

- [14.x](https://nodejs.org/docs/latest-v14.x/api/child_process.html)

- [13.x](https://nodejs.org/docs/latest-v13.x/api/child_process.html)

- [12.x](https://nodejs.org/docs/latest-v12.x/api/child_process.html)

- [11.x](https://nodejs.org/docs/latest-v11.x/api/child_process.html)

- [10.x](https://nodejs.org/docs/latest-v10.x/api/child_process.html)

- [9.x](https://nodejs.org/docs/latest-v9.x/api/child_process.html)

- [8.x](https://nodejs.org/docs/latest-v8.x/api/child_process.html)

- [7.x](https://nodejs.org/docs/latest-v7.x/api/child_process.html)

- [6.x](https://nodejs.org/docs/latest-v6.x/api/child_process.html)

- [5.x](https://nodejs.org/docs/latest-v5.x/api/child_process.html)

- [4.x](https://nodejs.org/docs/latest-v4.x/api/child_process.html)

- [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/child_process.html)

- [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/child_process.html)
...
**Source Code:** [lib/child_process.js](https://github.com/nodejs/node/blob/v25.6.1/lib/child_process.js)
...
console.log(`child process exited with code ${code}`);copy
...
[`child_process.spawn()`](#child_processspawncommand-args-options) with the `shell` option set, with
[`child_process.exec()`](#child_processexeccommand-options-callback), or by spawning `cmd.exe` and passing the `.bat` or
`.cmd` file as an argument (which is what the `shell` option and
[`child_process.exec()`](#child_processexeccommand-options-callback) do). In any case, if the script filename contains
...
- `cwd` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<URL>](url.html#the-whatwg-url-api) Current working directory of the child process.
**Default:** `process.cwd()`.
...
[Shell requirements](#shell-requirements) and [Default Windows shell](#default-windows-shell). **Default:**
...
- `stdout` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<Buffer>](buffer.html#class-buffer)

- `stderr` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<Buffer>](buffer.html#class-buffer)
...
- `modulePath` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<URL>](url.html#the-whatwg-url-api) The module to run in the child.
...
- `stdio` [<Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) | [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) See [`child_process.spawn()`](#child_processspawncommand-args-options)'s [`stdio`](#optionsstdio).
...
[<Stream>](stream.html#stream) object: Share a readable or writable stream that refers to a tty,
...
- `input` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<Buffer>](buffer.html#class-buffer) | [<TypedArray>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [<DataView>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) The value which will be passed
...
[`maxBuffer` and Unicode](#maxbuffer-and-unicode). **Default:** `1024 * 1024`.
...
- Returns: [<Buffer>](buffer.html#class-buffer) | [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) The stdout from the command.
...
- `stdout` [<Buffer>](buffer.html#class-buffer) | [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) The contents of `output[1]`.

- `stderr` [<Buffer>](buffer.html#class-buffer) | [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) The contents of `output[2]`.
...
const [code] = await once(ls, 'close');
console.log(`child process close all stdio with code ${code}`);copy
...
- `sendHandle` [<Handle>](net.html#serverlistenhandle-backlog-callback) | [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) `undefined` or a [`net.Socket`](net.html#class-netsocket),
...
- Type: [<stream.Readable>](stream.html#class-streamreadable) | [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) | [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type)
...
- Type: [<stream.Writable>](stream.html#class-streamwritable) | [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) | [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type)
