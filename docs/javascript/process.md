...
- [25.x](https://nodejs.org/docs/latest-v25.x/api/process.html)

- [24.x LTS](https://nodejs.org/docs/latest-v24.x/api/process.html)

- [23.x](https://nodejs.org/docs/latest-v23.x/api/process.html)

- [22.x LTS](https://nodejs.org/docs/latest-v22.x/api/process.html)

- [21.x](https://nodejs.org/docs/latest-v21.x/api/process.html)

- [20.x LTS](https://nodejs.org/docs/latest-v20.x/api/process.html)

- [19.x](https://nodejs.org/docs/latest-v19.x/api/process.html)

- [18.x](https://nodejs.org/docs/latest-v18.x/api/process.html)

- [17.x](https://nodejs.org/docs/latest-v17.x/api/process.html)

- [16.x](https://nodejs.org/docs/latest-v16.x/api/process.html)

- [15.x](https://nodejs.org/docs/latest-v15.x/api/process.html)

- [14.x](https://nodejs.org/docs/latest-v14.x/api/process.html)

- [13.x](https://nodejs.org/docs/latest-v13.x/api/process.html)

- [12.x](https://nodejs.org/docs/latest-v12.x/api/process.html)

- [11.x](https://nodejs.org/docs/latest-v11.x/api/process.html)

- [10.x](https://nodejs.org/docs/latest-v10.x/api/process.html)

- [9.x](https://nodejs.org/docs/latest-v9.x/api/process.html)

- [8.x](https://nodejs.org/docs/latest-v8.x/api/process.html)

- [7.x](https://nodejs.org/docs/latest-v7.x/api/process.html)

- [6.x](https://nodejs.org/docs/latest-v6.x/api/process.html)

- [5.x](https://nodejs.org/docs/latest-v5.x/api/process.html)

- [4.x](https://nodejs.org/docs/latest-v4.x/api/process.html)

- [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/process.html)

- [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/process.html)
...
**Source Code:** [lib/process.js](https://github.com/nodejs/node/blob/v25.6.1/lib/process.js)
...
- `value` [<any>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Data_types) A value transmitted using [`postMessageToThread()`](worker_threads.html#worker_threadspostmessagetothreadthreadid-value-transferlist-timeout).
...
[Stability: 0](documentation.html#stability-index) - Deprecated. This property is always true, and any checks based on it are
redundant.
...
[Stability: 0](documentation.html#stability-index) - Deprecated. Use `process.features.tls` instead.
...
[Stability: 3](documentation.html#stability-index) - Legacy. Use [`process.hrtime.bigint()`](#processhrtimebigint) instead.
...
Signal names are strings such as `'SIGINT'` or `'SIGHUP'`. See [Signal Events](#signal-events)
...
- `path` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<URL>](url.html#the-whatwg-url-api) | [<Buffer>](buffer.html#class-buffer) | [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type). **Default:** `'./.env'`
...
[Stability: 0](documentation.html#stability-index) - Deprecated: Use [`require.main`](modules.html#accessing-the-main-module) instead.
...
[Stability: 3](documentation.html#stability-index) - Legacy: Use [`queueMicrotask()`](globals.html#queuemicrotaskcallback) instead.
...
- `sourceUrl` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) an absolute URL pointing to a *`.tar.gz`* file containing
the source code of the current release.

- `headersUrl`[<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) an absolute URL pointing to a *`.tar.gz`* file containing
only the source header files for the current release. This file is
significantly smaller than the full source file and can be used for compiling
Node.js native add-ons.

- `libUrl` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) | [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) an absolute URL pointing to a *`node.lib`* file
...
[Stability: 1](documentation.html#stability-index) - Experimental: Use [`module.setSourceMapsSupport()`](module.html#modulesetsourcemapssupportenabled-options) instead.
...
[Stability: 1](documentation.html#stability-index) - Experimental: Use [`module.getSourceMapsSupport()`](module.html#modulegetsourcemapssupport) instead.
...
- They are used internally by [`console.log()`](console.html#consolelogdata-args) and [`console.error()`](console.html#consoleerrordata-args),
respectively.
...
process.traceProcessWarnings = false; copy
...
[Stability: 0](documentation.html#stability-index) - Deprecated. Calling `process.umask()` with no argument causes
