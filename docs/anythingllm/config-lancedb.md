# Source: https://docs.anythingllm.com/setup/vector-database-configuration/local/lancedb
...
By default, AnythingLLM will use an open-source on-instance of LanceDB (opens in a new tab) vector database so that your document text and embeddings never leave the AnythingLLM application.
