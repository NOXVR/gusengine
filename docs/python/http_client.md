...
http.client â HTTP protocol client — Python 3.14.3 documentation
...
# `http.client` â HTTP protocol client[Â¶](#module-http.client)
...
[`urllib.request`](urllib.request.html#module-urllib.request) uses it to handle URLs that use HTTP and HTTPS.
...
(through the [`ssl`](ssl.html#module-ssl) module).
...
class http.client.HTTPConnection(host, port=None, [timeout, ]source_address=None, blocksize=8192)[Â¶](#http.client.HTTPConnection)
...
Changed in version 3.4: The  *strict* parameter was removed. HTTP 0.9-style âSimple Responsesâ are
no longer supported.

Changed in version 3.7: *blocksize* parameter was added.

class http.client.HTTPSConnection(host, port=None, *, [timeout, ]source_address=None, context=None, blocksize=8192)[Â¶](#http.client.HTTPSConnection)

A subclass of [`HTTPConnection`](#http.client.HTTPConnection) that uses SSL for communication with
secure servers.  Default port is `443`.  If *context* is specified, it
must be a [`ssl.SSLContext`](ssl.html#ssl.SSLContext) instance describing the various SSL
options.
...
if [`ssl.HAS_SNI`](ssl.html#ssl.HAS_SNI) is true).
...
[`ssl.SSLContext.post_handshake_auth`](ssl.html#ssl.SSLContext.post_handshake_auth) for the default *context* or
...
class http.client.HTTPResponse(sock, debuglevel=0, method=None, url=None)[Â¶](#http.client.HTTPResponse)
...
http.client.parse_headers(fp)[Â¶](#http.client.parse_headers)

Parse the headers from a file pointer *fp* representing a HTTP
request/response. The file has to be a [`BufferedIOBase`](io.html#io.BufferedIOBase) reader
...
and [`http.server.BaseHTTPRequestHandler.headers`](http.server.html#http.server.BaseHTTPRequestHandler.headers)).
...
exception http.client.HTTPException[Â¶](#http.client.HTTPException)

The base class of the other exceptions in this module.  It is a subclass of
[`Exception`](exceptions.html#Exception).

exception http.client.NotConnected[Â¶](#http.client.NotConnected)

A subclass of [`HTTPException`](#http.client.HTTPException).

exception http.client.InvalidURL[Â¶](#http.client.InvalidURL)

A subclass of [`HTTPException`](#http.client.HTTPException), raised if a port is given and is either
non-numeric or empty.

exception http.client.UnknownProtocol[Â¶](#http.client.UnknownProtocol)

A subclass of [`HTTPException`](#http.client.HTTPException).

exception http.client.UnknownTransferEncoding[Â¶](#http.client.UnknownTransferEncoding)

A subclass of [`HTTPException`](#http.client.HTTPException).

exception http.client.UnimplementedFileMode[Â¶](#http.client.UnimplementedFileMode)

A subclass of [`HTTPException`](#http.client.HTTPException).

exception http.client.IncompleteRead[Â¶](#http.client.IncompleteRead)

A subclass of [`HTTPException`](#http.client.HTTPException).

exception http.client.ImproperConnectionState[Â¶](#http.client.ImproperConnectionState)

A subclass of [`HTTPException`](#http.client.HTTPException).

exception http.client.CannotSendRequest[Â¶](#http.client.CannotSendRequest)

A subclass of [`ImproperConnectionState`](#http.client.ImproperConnectionState).

exception http.client.CannotSendHeader[Â¶](#http.client.CannotSendHeader)

A subclass of [`ImproperConnectionState`](#http.client.ImproperConnectionState).

exception http.client.ResponseNotReady[Â¶](#http.client.ResponseNotReady)

A subclass of [`ImproperConnectionState`](#http.client.ImproperConnectionState).

exception http.client.BadStatusLine[Â¶](#http.client.BadStatusLine)

A subclass of [`HTTPException`](#http.client.HTTPException).  Raised if a server responds with a HTTP
status code that we donât understand.

exception http.client.LineTooLong[Â¶](#http.client.LineTooLong)

A subclass of [`HTTPException`](#http.client.HTTPException).  Raised if an excessively long line
is received in the HTTP protocol from the server.

exception http.client.RemoteDisconnected[Â¶](#http.client.RemoteDisconnected)

A subclass of [`ConnectionResetError`](exceptions.html#ConnectionResetError) and [`BadStatusLine`](#http.client.BadStatusLine).  Raised
...
http.client.HTTP_PORT[Â¶](#http.client.HTTP_PORT)

The default port for the HTTP protocol (always `80`).

http.client.HTTPS_PORT[Â¶](#http.client.HTTPS_PORT)

The default port for the HTTPS protocol (always `443`).

http.client.responses[Â¶](#http.client.responses)
...
## HTTPConnection Objects[Â¶](#httpconnection-objects)

[`HTTPConnection`](#http.client.HTTPConnection) instances have the following methods:

HTTPConnection.request(method, url, body=None, headers={}, *, encode_chunked=False)[Â¶](#http.client.HTTPConnection.request)

This will send a request to the server using the HTTP request
method *method* and the request URI *url*. The provided *url* must be
an absolute path to conform with [**RFC 2616 Â§5.1.2**](https://datatracker.ietf.org/doc/html/rfc2616.html#section-5.1.2)
(unless connecting to an HTTP proxy server or using the `OPTIONS` or
`CONNECT` methods).

If *body* is specified, the specified data is sent after the headers are
finished.  It may be a [`str`](stdtypes.html#str), a [bytes-like object](../glossary.html#term-bytes-like-object), an
open [file object](../glossary.html#term-file-object), or an iterable of [`bytes`](stdtypes.html#bytes).  If *body*
...
instance of [`io.TextIOBase`](io.html#io.TextIOBase), the data returned by the `read()`
...
must be provided to conform with [**RFC 2616 Â§5.1.2**](https://datatracker.ietf.org/doc/html/rfc2616.html#section-5.1.2)
(unless connecting to an HTTP proxy server or using the `OPTIONS` or
`CONNECT` methods).
...
[`str`](stdtypes.html#str) or bytes-like object that is not also a file as the
body representation.

Note

Note that you must have read the whole response or call [`close()`](#http.client.HTTPConnection.close)
if [`getresponse()`](#http.client.HTTPConnection.getresponse) raised an non-[`ConnectionError`](exceptions.html#ConnectionError) exception
...
HTTPConnection.getresponse()[Â¶](#http.client.HTTPConnection.getresponse)

Should be called after a request is sent to get the response from the server.
Returns an [`HTTPResponse`](#http.client.HTTPResponse) instance.

Changed in version 3.5: If a [`ConnectionError`](exceptions.html#ConnectionError) or subclass is raised, the
[`HTTPConnection`](#http.client.HTTPConnection) object will be ready to reconnect when
a new request is sent.

Note that this does not apply to [`OSError`](exceptions.html#OSError)s raised by the underlying
socket. Instead the caller is responsible to call [`close()`](#http.client.HTTPConnection.close) on the
existing connection.

HTTPConnection.set_debuglevel(level)[Â¶](#http.client.HTTPConnection.set_debuglevel)
...
HTTPConnection.set_tunnel(host, port=None, headers=None)[Â¶](#http.client.HTTPConnection.set_tunnel)
...
HTTPConnection.get_proxy_response_headers()[Â¶](#http.client.HTTPConnection.get_proxy_response_headers)
...
HTTPConnection.connect()[Â¶](#http.client.HTTPConnection.connect)
...
HTTPConnection.close()[Â¶](#http.client.HTTPConnection.close)

Close the connection to the server.

HTTPConnection.blocksize[Â¶](#http.client.HTTPConnection.blocksize)
...
HTTPConnection.putrequest(method, url, skip_host=False, skip_accept_encoding=False)[Â¶](#http.client.HTTPConnection.putrequest)
...
HTTPConnection.putheader(header, argument[, ...])[Â¶](#http.client.HTTPConnection.putheader)
...
HTTPConnection.endheaders(message_body=None, *, encode_chunked=False)[Â¶](#http.client.HTTPConnection.endheaders)
...
*message_body*.  If *message_body* implements the [buffer interface](../c-api/buffer.html#bufferobjects) the encoding will result in a single chunk.
If *message_body* is a [`collections.abc.Iterable`](collections.abc.html#collections.abc.Iterable), each iteration
...
HTTPConnection.send(data)[Â¶](#http.client.HTTPConnection.send)
...
## HTTPResponse Objects[Â¶](#httpresponse-objects)
...
Changed in version 3.5: The [`io.BufferedIOBase`](io.html#io.BufferedIOBase) interface is now implemented and
all of its reader operations are supported.

HTTPResponse.read([amt])[Â¶](#http.client.HTTPResponse.read)

Reads and returns the response body, or up to the next *amt* bytes.

HTTPResponse.readinto(b)[Â¶](#http.client.HTTPResponse.readinto)
...
HTTPResponse.getheader(name, default=None)[Â¶](#http.client.HTTPResponse.getheader)

Return the value of the header *name*, or *default* if there is no header
matching *name*.  If there is more than one  header with the name *name*,
return all of the values joined by â, â.  If *default* is any iterable other
than a single string, its elements are similarly returned joined by commas.

HTTPResponse.getheaders()[Â¶](#http.client.HTTPResponse.getheaders)

Return a list of (header, value) tuples.

HTTPResponse.fileno()[Â¶](#http.client.HTTPResponse.fileno)

Return the `fileno` of the underlying socket.

HTTPResponse.msg[Â¶](#http.client.HTTPResponse.msg)
...
[`email.message.Message`](email.compat32-message.html#email.message.Message).

HTTPResponse.version[Â¶](#http.client.HTTPResponse.version)

HTTP protocol version used by server.  10 for HTTP/1.0, 11 for HTTP/1.1.

HTTPResponse.url[Â¶](#http.client.HTTPResponse.url)

URL of the resource retrieved, commonly used to determine if a redirect was followed.

HTTPResponse.headers[Â¶](#http.client.HTTPResponse.headers)

Headers of the response in the form of an [`email.message.EmailMessage`](email.message.html#email.message.EmailMessage) instance.

HTTPResponse.status[Â¶](#http.client.HTTPResponse.status)

Status code returned by server.

HTTPResponse.reason[Â¶](#http.client.HTTPResponse.reason)

Reason phrase returned by server.

HTTPResponse.debuglevel[Â¶](#http.client.HTTPResponse.debuglevel)

A debugging hook.  If [`debuglevel`](#http.client.HTTPResponse.debuglevel) is greater than zero, messages
will be printed to stdout as the response is read and parsed.

HTTPResponse.closed[Â¶](#http.client.HTTPResponse.closed)

Is `True` if the stream is closed.

HTTPResponse.geturl()[Â¶](#http.client.HTTPResponse.geturl)

Deprecated since version 3.9: Deprecated in favor of [`url`](#http.client.HTTPResponse.url).

HTTPResponse.info()[Â¶](#http.client.HTTPResponse.info)

Deprecated since version 3.9: Deprecated in favor of [`headers`](#http.client.HTTPResponse.headers).

HTTPResponse.getcode()[Â¶](#http.client.HTTPResponse.getcode)
...
are also handled in [`urllib.request.Request`](urllib.request.html#urllib.request.Request) by setting the appropriate
...
## HTTPMessage Objects[Â¶](#httpmessage-objects)

class http.client.HTTPMessage(email.message.Message)[Â¶](#http.client.HTTPMessage)

An [`http.client.HTTPMessage`](#http.client.HTTPMessage) instance holds the headers from an HTTP
response.  It is implemented using the [`email.message.Message`](email.compat32-message.html#email.message.Message) class.
...
[`ftplib` â FTP protocol client](ftplib.html)
