...
socket â Low-level networking interface — Python 3.14.3 documentation
...
# `socket` â Low-level networking interface[Â¶](#module-socket)
...
call and library interface for sockets to Pythonâs object-oriented style: the
...
Module [`socketserver`](socketserver.html#module-socketserver)
Classes that simplify writing network servers.

Module [`ssl`](ssl.html#module-ssl)
A TLS/SSL wrapper for socket objects.

## Socket families[Â¶](#socket-families)
...
Linuxâs abstract namespace is returned as a [bytes-like object](../glossary.html#term-bytes-like-object) with
...
- 
[`CAN_ISOTP`](#socket.CAN_ISOTP) protocol require a tuple `(interface, rx_addr, tx_addr)`
where both additional parameters are unsigned long integer that represent a
CAN identifier (standard or extended).

- 
[`CAN_J1939`](#socket.CAN_J1939) protocol require a tuple `(interface, name, pgn, addr)`
...
exception socket.error[Â¶](#socket.error)
...
exception socket.herror[Â¶](#socket.herror)
...
Changed in version 3.3: This class was made a subclass of [`OSError`](exceptions.html#OSError).

exception socket.gaierror[Â¶](#socket.gaierror)
...
exception socket.timeout[Â¶](#socket.timeout)

A deprecated alias of [`TimeoutError`](exceptions.html#TimeoutError).

A subclass of [`OSError`](exceptions.html#OSError), this exception is raised when a timeout
...
whose value is currently always âtimed outâ.

Changed in version 3.3: This class was made a subclass of [`OSError`](exceptions.html#OSError).

Changed in version 3.10: This class was made an alias of [`TimeoutError`](exceptions.html#TimeoutError).

### Constants[Â¶](#constants)

The AF_* and SOCK_* constants are now `AddressFamily` and
`SocketKind` [`IntEnum`](enum.html#enum.IntEnum) collections.

Added in version 3.4.

socket.AF_UNIX[Â¶](#socket.AF_UNIX)

socket.AF_INET[Â¶](#socket.AF_INET)

socket.AF_INET6[Â¶](#socket.AF_INET6)
...
socket.AF_UNSPEC[Â¶](#socket.AF_UNSPEC)
...
socket.SOCK_STREAM[Â¶](#socket.SOCK_STREAM)

socket.SOCK_DGRAM[Â¶](#socket.SOCK_DGRAM)

socket.SOCK_RAW[Â¶](#socket.SOCK_RAW)

socket.SOCK_RDM[Â¶](#socket.SOCK_RDM)

socket.SOCK_SEQPACKET[Â¶](#socket.SOCK_SEQPACKET)
...
socket.SOCK_CLOEXEC[Â¶](#socket.SOCK_CLOEXEC)

socket.SOCK_NONBLOCK[Â¶](#socket.SOCK_NONBLOCK)
...
socket.SOMAXCONN[Â¶](#socket.SOMAXCONN)
...
socket.AF_CAN[Â¶](#socket.AF_CAN)

socket.PF_CAN[Â¶](#socket.PF_CAN)
...
socket.CAN_BCM[Â¶](#socket.CAN_BCM)
...
socket.CAN_RAW_FD_FRAMES[Â¶](#socket.CAN_RAW_FD_FRAMES)
...
socket.CAN_RAW_JOIN_FILTERS[Â¶](#socket.CAN_RAW_JOIN_FILTERS)
...
socket.CAN_ISOTP[Â¶](#socket.CAN_ISOTP)
...
socket.CAN_J1939[Â¶](#socket.CAN_J1939)
...
socket.AF_DIVERT[Â¶](#socket.AF_DIVERT)

socket.PF_DIVERT[Â¶](#socket.PF_DIVERT)
...
socket.AF_PACKET[Â¶](#socket.AF_PACKET)

socket.PF_PACKET[Â¶](#socket.PF_PACKET)
...
socket.ETH_P_ALL[Â¶](#socket.ETH_P_ALL)
...
socket.AF_RDS[Â¶](#socket.AF_RDS)

socket.PF_RDS[Â¶](#socket.PF_RDS)

socket.SOL_RDS[Â¶](#socket.SOL_RDS)
...
socket.SIO_RCVALL[Â¶](#socket.SIO_RCVALL)

socket.SIO_KEEPALIVE_VALS[Â¶](#socket.SIO_KEEPALIVE_VALS)

socket.SIO_LOOPBACK_FAST_PATH[Â¶](#socket.SIO_LOOPBACK_FAST_PATH)

RCVALL_*

Constants for Windowsâ WSAIoctl(). The constants are used as arguments to the
...
socket.AF_ALG[Â¶](#socket.AF_ALG)

socket.SOL_ALG[Â¶](#socket.SOL_ALG)
...
socket.AF_VSOCK[Â¶](#socket.AF_VSOCK)

socket.IOCTL_VM_SOCKETS_GET_LOCAL_CID[Â¶](#socket.IOCTL_VM_SOCKETS_GET_LOCAL_CID)
...
socket.AF_LINK[Â¶](#socket.AF_LINK)

[Availability](intro.html#availability): BSD, macOS.

Added in version 3.4.

socket.has_ipv6[Â¶](#socket.has_ipv6)

This constant contains a boolean value which indicates if IPv6 is supported on
this platform.

socket.AF_BLUETOOTH[Â¶](#socket.AF_BLUETOOTH)

socket.BTPROTO_L2CAP[Â¶](#socket.BTPROTO_L2CAP)

socket.BTPROTO_RFCOMM[Â¶](#socket.BTPROTO_RFCOMM)

socket.BTPROTO_HCI[Â¶](#socket.BTPROTO_HCI)

socket.BTPROTO_SCO[Â¶](#socket.BTPROTO_SCO)

Integer constants for use with Bluetooth addresses.

socket.BDADDR_ANY[Â¶](#socket.BDADDR_ANY)

socket.BDADDR_LOCAL[Â¶](#socket.BDADDR_LOCAL)
...
socket.BDADDR_BREDR[Â¶](#socket.BDADDR_BREDR)

socket.BDADDR_LE_PUBLIC[Â¶](#socket.BDADDR_LE_PUBLIC)

socket.BDADDR_LE_RANDOM[Â¶](#socket.BDADDR_LE_RANDOM)
...
socket.SOL_RFCOMM[Â¶](#socket.SOL_RFCOMM)

socket.SOL_L2CAP[Â¶](#socket.SOL_L2CAP)

socket.SOL_HCI[Â¶](#socket.SOL_HCI)

socket.SOL_SCO[Â¶](#socket.SOL_SCO)

socket.SOL_BLUETOOTH[Â¶](#socket.SOL_BLUETOOTH)
...
socket.L2CAP_LM[Â¶](#socket.L2CAP_LM)
...
socket.HCI_FILTER[Â¶](#socket.HCI_FILTER)

socket.HCI_TIME_STAMP[Â¶](#socket.HCI_TIME_STAMP)

socket.HCI_DATA_DIR[Â¶](#socket.HCI_DATA_DIR)

socket.SO_HCI_EVT_FILTER[Â¶](#socket.SO_HCI_EVT_FILTER)

socket.SO_HCI_PKT_FILTER[Â¶](#socket.SO_HCI_PKT_FILTER)
...
socket.HCI_DEV_NONE[Â¶](#socket.HCI_DEV_NONE)

The `device_id` value used to create an HCI socket that isnât specific
...
socket.HCI_CHANNEL_RAW[Â¶](#socket.HCI_CHANNEL_RAW)

socket.HCI_CHANNEL_USER[Â¶](#socket.HCI_CHANNEL_USER)

socket.HCI_CHANNEL_MONITOR[Â¶](#socket.HCI_CHANNEL_MONITOR)

socket.HCI_CHANNEL_CONTROL[Â¶](#socket.HCI_CHANNEL_CONTROL)

socket.HCI_CHANNEL_LOGGING[Â¶](#socket.HCI_CHANNEL_LOGGING)
...
socket.AF_QIPCRTR[Â¶](#socket.AF_QIPCRTR)

Constant for Qualcommâs IPC router protocol, used to communicate with
service providing remote processors.

[Availability](intro.html#availability): Linux >= 4.7.

socket.SCM_CREDS2[Â¶](#socket.SCM_CREDS2)

socket.LOCAL_CREDS[Â¶](#socket.LOCAL_CREDS)

socket.LOCAL_CREDS_PERSISTENT[Â¶](#socket.LOCAL_CREDS_PERSISTENT)
...
socket.SO_INCOMING_CPU[Â¶](#socket.SO_INCOMING_CPU)
...
socket.SO_REUSEPORT_LB[Â¶](#socket.SO_REUSEPORT_LB)
...
socket.AF_HYPERV[Â¶](#socket.AF_HYPERV)

socket.HV_PROTOCOL_RAW[Â¶](#socket.HV_PROTOCOL_RAW)

socket.HVSOCKET_CONNECT_TIMEOUT[Â¶](#socket.HVSOCKET_CONNECT_TIMEOUT)

socket.HVSOCKET_CONNECT_TIMEOUT_MAX[Â¶](#socket.HVSOCKET_CONNECT_TIMEOUT_MAX)

socket.HVSOCKET_CONNECTED_SUSPEND[Â¶](#socket.HVSOCKET_CONNECTED_SUSPEND)

socket.HVSOCKET_ADDRESS_FLAG_PASSTHRU[Â¶](#socket.HVSOCKET_ADDRESS_FLAG_PASSTHRU)

socket.HV_GUID_ZERO[Â¶](#socket.HV_GUID_ZERO)

socket.HV_GUID_WILDCARD[Â¶](#socket.HV_GUID_WILDCARD)

socket.HV_GUID_BROADCAST[Â¶](#socket.HV_GUID_BROADCAST)

socket.HV_GUID_CHILDREN[Â¶](#socket.HV_GUID_CHILDREN)

socket.HV_GUID_LOOPBACK[Â¶](#socket.HV_GUID_LOOPBACK)

socket.HV_GUID_PARENT[Â¶](#socket.HV_GUID_PARENT)
...
socket.ETHERTYPE_ARP[Â¶](#socket.ETHERTYPE_ARP)

socket.ETHERTYPE_IP[Â¶](#socket.ETHERTYPE_IP)

socket.ETHERTYPE_IPV6[Â¶](#socket.ETHERTYPE_IPV6)

socket.ETHERTYPE_VLAN[Â¶](#socket.ETHERTYPE_VLAN)
...
socket.SHUT_RD[Â¶](#socket.SHUT_RD)

socket.SHUT_WR[Â¶](#socket.SHUT_WR)

socket.SHUT_RDWR[Â¶](#socket.SHUT_RDWR)
...
#### Creating sockets[Â¶](#creating-sockets)

The following functions all create [socket objects](#socket-objects).

class socket.socket(family=AF_INET, type=SOCK_STREAM, proto=0, fileno=None)[Â¶](#socket.socket)
...
socket.socketpair([family[, type[, proto]]])[Â¶](#socket.socketpair)

Build a pair of connected socket objects using the given address family, socket
type, and protocol number.  Address family, socket type, and protocol number are
as for the [`socket()`](#socket.socket) function above. The default family is [`AF_UNIX`](#socket.AF_UNIX)
...
socket.create_connection(address, timeout=GLOBAL_DEFAULT, source_address=None, *, all_errors=False)[Â¶](#socket.create_connection)
...
are ââ or 0 respectively the OS default behavior will be used.
...
is `True`, it is an [`ExceptionGroup`](exceptions.html#ExceptionGroup) containing the errors of all
attempts.
...
socket.create_server(address, *, family=AF_INET, backlog=None, reuse_port=False, dualstack_ipv6=False)[Â¶](#socket.create_server)
...
else it will raise [`ValueError`](exceptions.html#ValueError). Most POSIX platforms and Windows are
...
socket.has_dualstack_ipv6()[Â¶](#socket.has_dualstack_ipv6)
...
socket.fromfd(fd, family, type, proto=0)[Â¶](#socket.fromfd)

Duplicate the file descriptor *fd* (an integer as returned by a file objectâs
[`fileno()`](io.html#io.IOBase.fileno) method) and build a socket object from the result.  Address
...
socket.fromshare(data)[Â¶](#socket.fromshare)
...
socket.SocketType[Â¶](#socket.SocketType)

This is a Python type object that represents the socket object type. It is the
same as `type(socket(...))`.

#### Other functions[Â¶](#other-functions)

The `socket` module also offers various network-related services:

socket.close(fd)[Â¶](#socket.close)

Close a socket file descriptor. This is like [`os.close()`](os.html#os.close), but for
sockets. On some platforms (most noticeable Windows) [`os.close()`](os.html#os.close)
does not work for socket file descriptors.

Added in version 3.7.

socket.getaddrinfo(host, port, family=AF_UNSPEC, type=0, proto=0, flags=0)[Â¶](#socket.getaddrinfo)
...
[`AF_INET`](#socket.AF_INET), a `(address, port, flowinfo, scope_id)` 4-tuple for
[`AF_INET6`](#socket.AF_INET6)), and is meant to be passed to the [`socket.connect()`](#socket.socket.connect)
method.
...
socket.getfqdn([name])[Â¶](#socket.getfqdn)
...
socket.gethostbyname(hostname)[Â¶](#socket.gethostbyname)
...
socket.gethostbyname_ex(hostname)[Â¶](#socket.gethostbyname_ex)
...
socket.gethostname()[Â¶](#socket.gethostname)
...
Note: [`gethostname()`](#socket.gethostname) doesnât always return the fully qualified domain
name; use [`getfqdn()`](#socket.getfqdn) for that.

[Availability](intro.html#availability): not WASI.

socket.gethostbyaddr(ip_address)[Â¶](#socket.gethostbyaddr)
...
socket.getnameinfo(sockaddr, flags)[Â¶](#socket.getnameinfo)
...
socket.getprotobyname(protocolname)[Â¶](#socket.getprotobyname)

Translate an internet protocol name (for example, `'icmp'`) to a constant
suitable for passing as the (optional) third argument to the [`socket()`](#socket.socket)
function.  This is usually only needed for sockets opened in ârawâ mode
([`SOCK_RAW`](#socket.SOCK_RAW)); for the normal socket modes, the correct protocol is chosen
automatically if the protocol is omitted or zero.

[Availability](intro.html#availability): not WASI.

socket.getservbyname(servicename[, protocolname])[Â¶](#socket.getservbyname)
...
socket.getservbyport(port[, protocolname])[Â¶](#socket.getservbyport)
...
socket.ntohl(x)[Â¶](#socket.ntohl)

Convert 32-bit positive integers from network to host byte order.  On machines
where the host byte order is the same as network byte order, this is a no-op;
otherwise, it performs a 4-byte swap operation.

socket.ntohs(x)[Â¶](#socket.ntohs)

Convert 16-bit positive integers from network to host byte order.  On machines
where the host byte order is the same as network byte order, this is a no-op;
otherwise, it performs a 2-byte swap operation.

Changed in version 3.10: Raises [`OverflowError`](exceptions.html#OverflowError) if *x* does not fit in a 16-bit unsigned
integer.

socket.htonl(x)[Â¶](#socket.htonl)

Convert 32-bit positive integers from host to network byte order.  On machines
where the host byte order is the same as network byte order, this is a no-op;
otherwise, it performs a 4-byte swap operation.

socket.htons(x)[Â¶](#socket.htons)
...
socket.inet_aton(ip_string)[Â¶](#socket.inet_aton)
...
[`OSError`](exceptions.html#OSError) will be raised. Note that exactly what is valid depends on
...
socket.inet_ntoa(packed_ip)[Â¶](#socket.inet_ntoa)
...
length, [`OSError`](exceptions.html#OSError) will be raised. [`inet_ntoa()`](#socket.inet_ntoa) does not
support IPv6, and [`inet_ntop()`](#socket.inet_ntop) should be used instead for IPv4/v6 dual
stack support.

Changed in version 3.5: Writable [bytes-like object](../glossary.html#term-bytes-like-object) is now accepted.

socket.inet_pton(address_family, ip_string)[Â¶](#socket.inet_pton)
...
socket.inet_ntop(address_family, packed_ip)[Â¶](#socket.inet_ntop)
...
length for the specified address family, [`ValueError`](exceptions.html#ValueError) will be raised.
[`OSError`](exceptions.html#OSError) is raised for errors from the call to [`inet_ntop()`](#socket.inet_ntop).
...
socket.CMSG_LEN(length)[Â¶](#socket.CMSG_LEN)
...
buffer.  Raises [`OverflowError`](exceptions.html#OverflowError) if *length* is outside the
...
socket.CMSG_SPACE(length)[Â¶](#socket.CMSG_SPACE)
...
[`OverflowError`](exceptions.html#OverflowError) if *length* is outside the permissible range
of values.
...
socket.getdefaulttimeout()[Â¶](#socket.getdefaulttimeout)

Return the default timeout in seconds (float) for new socket objects. A value
of `None` indicates that new socket objects have no timeout. When the socket
module is first imported, the default is `None`.

socket.setdefaulttimeout(timeout)[Â¶](#socket.setdefaulttimeout)
...
socket.sethostname(name)[Â¶](#socket.sethostname)

Set the machineâs hostname to *name*.  This will raise an
[`OSError`](exceptions.html#OSError) if you donât have enough rights.
...
socket.if_nameindex()[Â¶](#socket.if_nameindex)

Return a list of network interface information
(index int, name string) tuples.
[`OSError`](exceptions.html#OSError) if the system call fails.
...
socket.if_nametoindex(if_name)[Â¶](#socket.if_nametoindex)

Return a network interface index number corresponding to an
interface name.
[`OSError`](exceptions.html#OSError) if no interface with the given name exists.
...
âInterface nameâ is a name as documented in [`if_nameindex()`](#socket.if_nameindex).

socket.if_indextoname(if_index)[Â¶](#socket.if_indextoname)

Return a network interface name corresponding to an
interface index number.
[`OSError`](exceptions.html#OSError) if no interface with the given index exists.
...
socket.send_fds(sock, buffers, fds[, flags[, address]])[Â¶](#socket.send_fds)
...
socket.recv_fds(sock, bufsize, maxfds[, flags])[Â¶](#socket.recv_fds)
...
## Socket Objects[Â¶](#socket-objects)
...
socket.accept()[Â¶](#socket.socket.accept)
...
an [`InterruptedError`](exceptions.html#InterruptedError) exception (see [**PEP 475**](https://peps.python.org/pep-0475/) for the rationale).

socket.bind(address)[Â¶](#socket.socket.bind)
...
socket.close()[Â¶](#socket.socket.close)
...
Changed in version 3.6: [`OSError`](exceptions.html#OSError) is now raised if an error occurs when the underlying
`close()` call is made.
...
socket.connect(address)[Â¶](#socket.socket.connect)

Connect to a remote socket at *address*. (The format of *address* depends on the
address family â see above.)

If the connection is interrupted by a signal, the method waits until the
connection completes, or raise a [`TimeoutError`](exceptions.html#TimeoutError) on timeout, if the
signal handler doesnât raise an exception and the socket is blocking or has
a timeout. For non-blocking sockets, the method raises an
[`InterruptedError`](exceptions.html#InterruptedError) exception if the connection is interrupted by a
...
socket.connect_ex(address)[Â¶](#socket.socket.connect_ex)
...
socket.detach()[Â¶](#socket.socket.detach)
...
socket.dup()[Â¶](#socket.socket.dup)
...
socket.fileno()[Â¶](#socket.socket.fileno)

Return the socketâs file descriptor (a small integer), or -1 on failure. This
is useful with [`select.select()`](select.html#select.select).

Under Windows the small integer returned by this method cannot be used where a
file descriptor can be used (such as [`os.fdopen()`](os.html#os.fdopen)).  Unix does not have
this limitation.

socket.get_inheritable()[Â¶](#socket.socket.get_inheritable)

Get the [inheritable flag](os.html#fd-inheritance) of the socketâs file
descriptor or socketâs handle: `True` if the socket can be inherited in
child processes, `False` if it cannot.

Added in version 3.4.

socket.getpeername()[Â¶](#socket.socket.getpeername)
...
socket.getsockname()[Â¶](#socket.socket.getsockname)

Return the socketâs own address.  This is useful to find out the port number of
an IPv4/v6 socket, for instance. (The format of the address returned depends on
the address family â see above.)

socket.getsockopt(level, optname[, buflen])[Â¶](#socket.socket.getsockopt)

Return the value of the given socket option (see the Unix man page
[getsockopt(2)](https://manpages.debian.org/getsockopt(2))).  The needed symbolic constants ([SO_* etc.](#socket-unix-constants))
...
contents of the buffer (see the optional built-in module [`struct`](struct.html#module-struct) for a way
to decode C structures encoded as byte strings).

[Availability](intro.html#availability): not WASI.

socket.getblocking()[Â¶](#socket.socket.getblocking)
...
socket.gettimeout()[Â¶](#socket.socket.gettimeout)
...
socket.ioctl(control, option)[Â¶](#socket.socket.ioctl)
...
On other platforms, the generic [`fcntl.fcntl()`](fcntl.html#fcntl.fcntl) and [`fcntl.ioctl()`](fcntl.html#fcntl.ioctl)
...
socket.listen([backlog])[Â¶](#socket.socket.listen)
...
socket.makefile(mode='r', buffering=None, *, encoding=None, errors=None, newline=None)[Â¶](#socket.socket.makefile)
...
interpreted the same way as by the built-in [`open()`](functions.html#open) function, except
...
Closing the file object returned by [`makefile()`](#socket.socket.makefile) wonât close the
...
stream arguments of [`subprocess.Popen()`](subprocess.html#subprocess.Popen).

socket.recv(bufsize[, flags])[Â¶](#socket.socket.recv)
...
socket.recvfrom(bufsize[, flags])[Â¶](#socket.socket.recvfrom)
...
to zero. (The format of *address* depends on the address family â see above.)
...
socket.recvmsg(bufsize[, ancbufsize[, flags]])[Â¶](#socket.socket.recvmsg)
...
address).  The *data* item is a [`bytes`](stdtypes.html#bytes) object holding the
...
[`bytes`](stdtypes.html#bytes) object holding the associated data.  The *msg_flags*
...
socket.SCM_RIGHTS, fds), where *fds* is a [`bytes`](stdtypes.html#bytes) object
representing the new file descriptors as a binary array of the
native C int type.  If [`recvmsg()`](#socket.socket.recvmsg) raises an
...
a [`RuntimeWarning`](exceptions.html#RuntimeWarning), and will return the part of it which is
...
socket.recvmsg_into(buffers[, ancbufsize[, flags]])[Â¶](#socket.socket.recvmsg_into)
...
writable buffers (e.g. [`bytearray`](stdtypes.html#bytearray) objects); these will be
...
system may set a limit ([`sysconf()`](os.html#os.sysconf) value `SC_IOV_MAX`)
...
socket.recvfrom_into(buffer[, nbytes[, flags]])[Â¶](#socket.socket.recvfrom_into)
...
depends on the address family â see above.)

socket.recv_into(buffer[, nbytes[, flags]])[Â¶](#socket.socket.recv_into)
...
socket.send(bytes[, flags])[Â¶](#socket.socket.send)

Send data to the socket.  The socket must be connected to a remote socket.  The
optional *flags* argument has the same meaning as for [`recv()`](#socket.socket.recv) above.
...
socket.sendall(bytes[, flags])[Â¶](#socket.socket.sendall)
...
socket.sendto(bytes, address)[Â¶](#socket.socket.sendto)

socket.sendto(bytes, flags, address)

Send data to the socket.  The socket should not be connected to a remote socket,
since the destination socket is specified by *address*.  The optional *flags*
argument has the same meaning as for [`recv()`](#socket.socket.recv) above.  Return the number of
...
socket.sendmsg(buffers[, ancdata[, flags[, address]]])[Â¶](#socket.socket.sendmsg)
...
(e.g. [`bytes`](stdtypes.html#bytes) objects); the operating system may set a limit
([`sysconf()`](os.html#os.sysconf) value `SC_IOV_MAX`) on the number of buffers
...
socket.sendmsg_afalg([msg, ]*, op[, iv[, assoclen[, flags]]])[Â¶](#socket.socket.sendmsg_afalg)
...
socket.sendfile(file, offset=0, count=None)[Â¶](#socket.socket.sendfile)

Send a file until EOF is reached by using high-performance
[`os.sendfile`](os.html#os.sendfile) and return the total number of bytes which were sent.
*file* must be a regular file object opened in binary mode. If
[`os.sendfile`](os.html#os.sendfile) is not available (e.g. Windows) or *file* is not a
...
[`file.tell()`](io.html#io.IOBase.tell) can be used to figure out the number of
bytes which were sent. The socket must be of [`SOCK_STREAM`](#socket.SOCK_STREAM) type.
Non-blocking sockets are not supported.

Added in version 3.5.

socket.set_inheritable(inheritable)[Â¶](#socket.socket.set_inheritable)

Set the [inheritable flag](os.html#fd-inheritance) of the socketâs file
descriptor or socketâs handle.

Added in version 3.4.

socket.setblocking(flag)[Â¶](#socket.socket.setblocking)
...
socket.settimeout(value)[Â¶](#socket.socket.settimeout)
...
socket.setsockopt(level, optname, value: [int](functions.html#int) | [Buffer](collections.abc.html#collections.abc.Buffer))[Â¶](#socket.socket.setsockopt)
...
`None` or a [bytes-like object](../glossary.html#term-bytes-like-object) representing a buffer. In the later
case it is up to the caller to ensure that the bytestring contains the
proper bits (see the optional built-in module [`struct`](struct.html#module-struct) for a way to
encode C structures as bytestrings). When *value* is set to `None`,
*optlen* argument is required. Itâs equivalent to call `setsockopt()` C
...
socket.shutdown(how)[Â¶](#socket.socket.shutdown)
...
socket.share(process_id)[Â¶](#socket.socket.share)
...
socket.family[Â¶](#socket.socket.family)

The socket family.

socket.type[Â¶](#socket.socket.type)

The socket type.

socket.proto[Â¶](#socket.socket.proto)

The socket protocol.

## Notes on socket timeouts[Â¶](#notes-on-socket-timeouts)
...
[`select`](select.html#module-select) module can be used to know when and whether a socket is available
...
### Timeouts and the `connect` method[Â¶](#timeouts-and-the-connect-method)
...
### Timeouts and the `accept` method[Â¶](#timeouts-and-the-accept-method)

If [`getdefaulttimeout()`](#socket.getdefaulttimeout) is not [`None`](constants.html#None), sockets returned by
...
state, and canât be immediately reused.
...
both in the UNIX Programmerâs Manual, Supplementary Documents 1 (sections
...
[`ssl` â TLS/SSL wrapper for socket objects](ssl.html)
