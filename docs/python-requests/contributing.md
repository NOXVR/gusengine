# Source: https://requests.readthedocs.io/en/latest/dev/contributing/
# Downloaded: 2026-02-16

---

Contributor’s Guide — Requests 2.33.0.dev1 documentation
...
questions, feel free to reach out to either Nate Prewitt, Ian Cordasco,
or Seth Michael Larson, the primary maintainers.
...
Python Software Foundation Code of Conduct to help steer your interactions
...
pre-commit. This can be installed locally and run over your changes prior
...
.pre-commit-config.yaml at the top level directory of Requests.
