...
[listen](ngx_http_core_module.html#listen) directives
of the
[server](ngx_http_core_module.html#server) blocks.
It then tests the “Host”
header field of the request against the
[server_name](ngx_http_core_module.html#server_name)
entries of the
[server](ngx_http_core_module.html#server)
blocks that matched
...
The
[fastcgi_param](ngx_http_fastcgi_module.html#fastcgi_param)
