...
by the [proxy_pass](ngx_http_proxy_module.html#proxy_pass),
...
[memcached_pass](ngx_http_memcached_module.html#memcached_pass), and
[grpc_pass](ngx_http_grpc_module.html#grpc_pass) directives.
...
periodic [health checks](ngx_http_upstream_hc_module.html) is
...
multiple [workers](../ngx_core_module.html#worker_processes),
...
[proxy_next_upstream](ngx_http_proxy_module.html#proxy_next_upstream),
[fastcgi_next_upstream](ngx_http_fastcgi_module.html#fastcgi_next_upstream),
[uwsgi_next_upstream](ngx_http_uwsgi_module.html#uwsgi_next_upstream),
[scgi_next_upstream](ngx_http_scgi_module.html#scgi_next_upstream),
[memcached_next_upstream](ngx_http_memcached_module.html#memcached_next_upstream), and
[grpc_next_upstream](ngx_http_grpc_module.html#grpc_next_upstream)
directives.
...
[hash](#hash), [ip_hash](#ip_hash), and [random](#random)
...
[http](ngx_http_core_module.html#resolver) block
...
[healthy](ngx_http_upstream_hc_module.html#health_check),
...
[API](ngx_http_api_module.html) module.
...
Additionally,
as part of our [commercial subscription](https://www.f5.com/products/nginx),
...
[API](ngx_http_api_module.html) module (1.13.3).

 
Prior to version 1.13.3,
the configuration was accessible only via a special location
handled by
[upstream_conf](ngx_http_upstream_conf_module.html#upstream_conf).
...
[changed](ngx_http_api_module.html#http_upstreams_http_upstream_name_servers_).
...
Changes made during
[configuration reload](../control.html#reconfiguration)
or [binary upgrade](../control.html#upgrade)
can be lost.
...
For HTTP, the [proxy_http_version](ngx_http_proxy_module.html#proxy_http_version)
...
[fastcgi_keep_conn](ngx_http_fastcgi_module.html#fastcgi_keep_conn)
...
The [proxy_http_version](ngx_http_proxy_module.html#proxy_http_version)
directive should be set to “`1.1`” or “`2`”
and the “Connection” header field should be cleared:
...
initiated by
“X-Accel-Redirect” or
[error_page](ngx_http_core_module.html#error_page),
...
“[$http_](ngx_http_core_module.html#var_http_)” prefix.
...
allows passing it
[through SNI](ngx_http_proxy_module.html#proxy_ssl_server_name):
