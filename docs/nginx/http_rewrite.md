...
[server](ngx_http_core_module.html#server) level
...
- 
a
[location](ngx_http_core_module.html#location)
...
but not more than
[10 times](ngx_http_core_module.html#internal).
...
[valid_referers](ngx_http_referer_module.html#valid_referers) directive.
...
[server_name_in_redirect](ngx_http_core_module.html#server_name_in_redirect) and
[port_in_redirect](ngx_http_core_module.html#port_in_redirect) directives.
...
See also the [error_page](ngx_http_core_module.html#error_page) directive.
...
into the [error_log](../ngx_core_module.html#error_log) at
the `notice` level.
...
[limit_rate](ngx_http_core_module.html#limit_rate)
