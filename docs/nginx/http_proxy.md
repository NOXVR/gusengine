...
     [proxy_allow_upstream](#proxy_allow_upstream)
     [proxy_bind](#proxy_bind)
     [proxy_bind_dynamic](#proxy_bind_dynamic)
...
     [proxy_pass_trailers](#proxy_pass_trailers)
     [proxy_read_timeout](#proxy_read_timeout)
     [proxy_redirect](#proxy_redirect)
     [proxy_request_buffering](#proxy_request_buffering)
     [proxy_request_dynamic](#proxy_request_dynamic)
...
     [proxy_ssl_key_log](#proxy_ssl_key_log)
...
When enabled, makes the [bind](#proxy_bind) operation
...
connections and
[NTLM authentication](ngx_http_upstream_module.html#ntlm).
...
and “Vary”
set the parameters of response [caching](#proxy_cache_valid);
...
[buffering](#proxy_buffering) of a response;
...
`denied`
the server [denied](#proxy_allow_upstream)
...
[normalized](ngx_http_core_module.html#location)
...
[WebSocket](websocket.html) proxying requires special
...
[location](ngx_http_core_module.html#location) and
...
HTTP/1.1 or HTTP/2 is [enabled](#proxy_http_version) for proxying.
...
[enabled](#proxy_http_version) for proxying,
