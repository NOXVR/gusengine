...
     [ssl_certificate_compression](#ssl_certificate_compression)
...
     [ssl_ech_file](#ssl_ech_file)
     [ssl_key_log](#ssl_key_log)
     [ssl_ocsp](#ssl_ocsp)
...
- 
set the number of
[worker processes](../ngx_core_module.html#worker_processes)
equal to the number of processors,

- 
enable
[keep-alive](ngx_http_core_module.html#keepalive_timeout)
connections,
...
- 
and possibly increase the session [lifetime](#ssl_session_timeout)
...
The `ssl` parameter
of the [listen](ngx_http_core_module.html#listen) directive
...
[certificate chains](configuring_https_servers.html#chains)
...
[error log](../ngx_core_module.html#error_log).
...
[different](configuring_https_servers.html#compatibility)
ciphers by default.
...
the [resolver](ngx_http_core_module.html#resolver) directive
...
on the [server](ngx_http_core_module.html#server) level,
...
the [server](ngx_http_core_module.html#server) block will be rejected.
...
[error_page](ngx_http_core_module.html#error_page) directive:
...
[proxy_set_header](ngx_http_proxy_module.html#proxy_set_header) directive;
...
[SNI](http://en.wikipedia.org/wiki/Server_Name_Indication)
if TLS 1.3 [ECH](#ssl_ech_file) was accepted,
otherwise “” (1.29.4);
