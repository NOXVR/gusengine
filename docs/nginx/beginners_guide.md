...
If it is not, see the [Installing nginx](install.html) page.
...
[Controlling nginx](control.html).
...
[server](http/ngx_http_core_module.html#server),
and
...
[main](ngx_core_module.html) context.
...
[server](http/ngx_http_core_module.html#server)
block inside the [http](http/ngx_http_core_module.html#http)
block with two [location](http/ngx_http_core_module.html#location)
blocks.
...
`server` blocks
[distinguished](http/request_processing.html) by ports on which
they [listen](http/ngx_http_core_module.html#listen) to
and by
[server names](http/server_names.html).
...
[proxy_pass](http/ngx_http_proxy_module.html#proxy_pass)
...
it first checks [location](http/ngx_http_core_module.html#location)
...
There are many [more](http/ngx_http_proxy_module.html)
...
and [fastcgi_param](http/ngx_http_fastcgi_module.html#fastcgi_param)
