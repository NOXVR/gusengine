...
must be enabled on
[listening sockets](ngx_http_core_module.html#listen)
in the [server](ngx_http_core_module.html#server) block,
and the locations of the
[server certificate](ngx_http_ssl_module.html#ssl_certificate)
and
[private key](ngx_http_ssl_module.html#ssl_certificate_key)
...
The directives [ssl_protocols](ngx_http_ssl_module.html#ssl_protocols) and
[ssl_ciphers](ngx_http_ssl_module.html#ssl_ciphers)
...
[changed](#compatibility) several times.
...
[keepalive](ngx_http_core_module.html#keepalive_timeout)
...
[ssl_session_cache](ngx_http_ssl_module.html#ssl_session_cache)
directive.
...
[ssl_session_timeout](ngx_http_ssl_module.html#ssl_session_timeout)
directive.
...
[ssl_certificate](ngx_http_ssl_module.html#ssl_certificate) directive:
...
[ssl](ngx_http_ssl_module.html#ssl) directive,
making it impossible to set up a single HTTP/HTTPS server.
The `ssl` parameter of the
[listen](ngx_http_core_module.html#listen) directive
