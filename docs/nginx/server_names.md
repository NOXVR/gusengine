...
[server_name](ngx_http_core_module.html#server_name)
directive
and determine which [server](ngx_http_core_module.html#server) block
is used for a given request.
See also “[How nginx processes a request](request_processing.html)”.
...
header field in a [server](ngx_http_core_module.html#server)
...
If no
[server_name](ngx_http_core_module.html#server_name)
is defined in a [server](ngx_http_core_module.html#server) block
...
by the
[server_name_in_redirect](ngx_http_core_module.html#server_name_in_redirect)
directive.
...
[listen](ngx_http_core_module.html#listen)
directive
and not of the
[server_name](ngx_http_core_module.html#server_name)
directive.
...
([IDNs](https://en.wikipedia.org/wiki/Internationalized_domain_name))
should be specified using an ASCII (Punycode) representation
in the [server_name](ngx_http_core_module.html#server_name) directive:
...
[SNI](configuring_https_servers.html#sni)
...
- 
in case of the
[ssl_protocols](ngx_http_ssl_module.html#ssl_protocols) directive,
...
- 
the
[client_header_buffer_size](ngx_http_core_module.html#client_header_buffer_size)
and
[merge_slashes](ngx_http_core_module.html#merge_slashes) directives
...
- 
in case of the
[ignore_invalid_headers](ngx_http_core_module.html#ignore_invalid_headers),
[large_client_header_buffers](ngx_http_core_module.html#large_client_header_buffers),
and
[underscores_in_headers](ngx_http_core_module.html#underscores_in_headers) directives
involved in processing request header fields,
it additionally depends
whether the server configuration was updated
according to the request line or the `Host` header field;

- 
an error response will be handled with
the [error_page](ngx_http_core_module.html#error_page) directive
...
the [server_names_hash_max_size](ngx_http_core_module.html#server_names_hash_max_size)
and [server_names_hash_bucket_size](ngx_http_core_module.html#server_names_hash_bucket_size)
directives at the http level may become necessary.
The default value of the
[server_names_hash_bucket_size](ngx_http_core_module.html#server_names_hash_bucket_size)
...
[server_names_hash_max_size](ngx_http_core_module.html#server_names_hash_max_size)
