...
[pool](../ngx_core_module.html#thread_pool).
...
[epoll](../events.html#epoll),
[kqueue](../events.html#kqueue),
and
[eventport](../events.html#eventport) methods.
...
`$request_body_file`
variable, or the
[$r->request_body_file](ngx_http_perl_module.html#methods)
method of the module
[ngx_http_perl_module](ngx_http_perl_module.html).
...
and [ngx_http_dav_module](ngx_http_dav_module.html)
...
[error_page](#error_page),
[index](ngx_http_index_module.html#index),
[internal_redirect](ngx_http_internal_redirect_module.html#internal_redirect),
[random_index](ngx_http_random_index_module.html#random_index), and
[try_files](#try_files) directives;
...
“`include virtual`”
command of the
[ngx_http_ssi_module](ngx_http_ssi_module.html)
module, by the
[ngx_http_addition_module](ngx_http_addition_module.html)
module directives, and by
[auth_request](ngx_http_auth_request_module.html#auth_request) and
[mirror](ngx_http_mirror_module.html#mirror) directives;

- 
requests changed by the
[rewrite](ngx_http_rewrite_module.html#rewrite) directive.
...
[proxy_ignore_headers](ngx_http_proxy_module.html#proxy_ignore_headers),
[fastcgi_ignore_headers](ngx_http_fastcgi_module.html#fastcgi_ignore_headers),
[uwsgi_ignore_headers](ngx_http_uwsgi_module.html#uwsgi_ignore_headers),
and
[scgi_ignore_headers](ngx_http_scgi_module.html#scgi_ignore_headers)
directives.
...
To control closing
[HTTP/2](ngx_http_v2_module.html) connections,
...
This allows for a more compact [configuration](configuring_https_servers.html#single_http_https_server) for the server that
...
the [http2](ngx_http_v2_module.html#http2) directive
should be used instead.

 

The `quic` parameter (1.25.0) configures the port to accept
[QUIC](ngx_http_v3_module.html) connections.
...
[proxy_pass](ngx_http_proxy_module.html#proxy_pass),
[fastcgi_pass](ngx_http_fastcgi_module.html#fastcgi_pass),
[uwsgi_pass](ngx_http_uwsgi_module.html#uwsgi_pass),
[scgi_pass](ngx_http_scgi_module.html#scgi_pass),
[memcached_pass](ngx_http_memcached_module.html#memcached_pass), or
[grpc_pass](ngx_http_grpc_module.html#grpc_pass),
...
[access_log](ngx_http_log_module.html#access_log).
...
and connections
[closed](ngx_http_rewrite_module.html#return)
...
enables
[collection](ngx_http_api_module.html#resolvers_)
...
(1.13.10),
or
[ngx_http_auth_oidc_module](ngx_http_auth_jwt_module.html)
(1.27.4)
...
“[How nginx processes a request](request_processing.html)” document.
...
[Server names](server_names.html) document.
...
a [build name](../configure.html#build)
...
[SSI](ngx_http_ssi_module.html#ssi_include_set).
...
and for [WebSocket](websocket.html) proxying.
...
“`:`” if
[$request_port](#var_request_port) is non-empty,
