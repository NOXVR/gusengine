...
NAME | DESCRIPTION | PATTERNS | TOKENS | ENVIRONMENT VARIABLES | FILES | SEE ALSO | AUTHORS | COLOPHON
...
## DESCRIPTION          top
       ...
       one â=â; the latter format is useful to avoid the need to quote
       ...
       Host    Restricts the following declarations (up to the next Host
               ...
               whitespace.  A single â*â as a pattern can be used to
               ...
               exclamation mark (â!â).  If a negated entry is matched,
               ...
               See âPATTERNSâ for more information on patterns.
       ...
       Match   Restricts the following declarations (up to the next Host
               ...
               prepending an exclamation mark (â!â).
               ...
               negation operators described in the âPATTERNSâ section.
       ...
       AddKeysToAgent
               ...
               interval using the format described in the âTIME FORMATSâ
       ...
       CertificateFile
               ...
               the âTOKENSâ section and environment variables as
               described in the âENVIRONMENT VARIABLESâ section.
       ...
       Ciphers
               ...
               (including wildcards) will be removed from the default set
               instead of replacing them.  If the specified list begins
               with a â^â character, then the specified ciphers will be
       ...
       ControlPath
               ...
               âTOKENSâ section and environment variables as described in
               the âENVIRONMENT VARIABLESâ section.  It is recommended
       ...
       EnableEscapeCommandline
               ...
               interactive sessions (default â~Câ).  By default, the
       ...
       EscapeChar
               Sets the escape character (default: â~â).  The escape
               character can also be set on the command line.  The
               argument should be a single character, â^â followed by a
       ...
       ForkAfterAuthentication
               ...
               option being set to âyesâ.  The recommended way to start
               ...
               âyesâ, then a client started with the
               ForkAfterAuthentication configuration option being set to
               âyesâ will wait for all remote port forwards to be
       ...
       ForwardAgent
               ...
               variable (beginning with â$â) in which to find the path.
       ...
       ForwardX11Timeout
               ...
               format described in the âTIME FORMATSâ section of
       ...
       HostKeyAlgorithms
               ...
               list begins with a â-â character, then the specified
       ...
       Hostname
               ...
               âTOKENSâ section.  Numeric IP addresses are also permitted
       ...
       IdentityAgent
               ...
               specified value begins with a â$â character, then it will
       ...
       IdentityFile
               ...
               in the âTOKENSâ section.  Alternately an argument of none
       ...
       Include
               ...
               glob(7) wildcards, tokens as described in the âTOKENSâ
               section, environment variables as described in the
               âENVIRONMENT VARIABLESâ section and, for user
               configurations, shell-like â~â references to user home
       ...
       KnownHostsCommand
               ...
               (described in the âVERIFYING HOST KEYSâ section in
               ssh(1)).  Arguments to KnownHostsCommand accept the tokens
               described in the âTOKENSâ section.  The command may be
       ...
       LocalCommand
               ...
               described in the âTOKENSâ section.
       ...
       LocalForward
               ...
               or â*â indicates that the port should be available from
               all interfaces.  Unix domain socket paths may use the
               tokens described in the âTOKENSâ section and environment
               variables as described in the âENVIRONMENT VARIABLESâ
               section.
       ...
       ProxyCommand
               ...
               executed using the user's shell âexecâ directive to avoid
               a lingering shell process.

               Arguments to ProxyCommand accept the tokens described in
               the âTOKENSâ section.  The command can be basically
       ...
       PubkeyAcceptedAlgorithms
               ...
               patterns.  If the specified list begins with a â+â
       ...
       RemoteCommand
               ...
               tokens described in the âTOKENSâ section.
       ...
       RemoteForward
               ...
               paths may use the tokens described in the âTOKENSâ section
               and environment variables as described in the âENVIRONMENT
               VARIABLESâ section.
               ...
               â*â or an empty string, then the forwarding is requested
       ...
       RevokedHostKeys
               ...
               user's home directory, the tokens described in the
               âTOKENSâ section and environment variables as described in
               the âENVIRONMENT VARIABLESâ section.
       ...
       SecurityKeyProvider
               ...
               If the specified value begins with a â$â character, then
       ...
       VerifyHostKeyDNS
               ...
               See also âVERIFYING HOST KEYSâ in ssh(1).
...
## PATTERNS          top
       ...
       A pattern consists of zero or more non-whitespace characters, â*â
       (a wildcard that matches zero or more characters), or â?â (a
       ...
       exclamation mark (â!â).  For example, to allow a key to be used
